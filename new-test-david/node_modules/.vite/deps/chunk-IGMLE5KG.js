...
import {
  ...
  useNavigate,
  useParams
} from "./chunk-YPKK7XWN.js";
import {
  require_debounce,
  require_eventemitter3
} from "./chunk-GANQH2TT.js";
import {
  require_baseUnset,
  require_getAllKeysIn
} from "./chunk-KXQHEJ3J.js";
import {
...
var I18nContextProvider = function(_a) {
  ...
  var _d = (0, import_react14.useState)(locale2 === value.getLocale()), isInitialized = _d[0], setInitialized = _d[1];
...
var TestTranslationProvider = function(_a) {
  ...
  return React5.createElement(I18nContextProvider, { value: {
...
function HistoryRouter(_a) {
  ...
  var _b = (0, import_react19.useState)({
  ...
  return React7.createElement(Router, { basename, children, location: state.location, navigationType: state.action, navigator: history });
}
...
var BasenameContext = (0, import_react20.createContext)("");

// node_modules/ra-core/dist/esm/routing/BasenameContextProvider.js
var BasenameContextProvider = function(_a) {
  var children = _a.children, basename = _a.basename;
  return React8.createElement(BasenameContext.Provider, { value: basename }, children);
};
...
var AdminRouter = function(_a) {
  ...
  return React9.createElement(
    ...
    React9.createElement(Router2, { basename, history }, children)
  );
};
...
var InternalRouter = function(_a) {
  ...
  var finalHistory = (0, import_react21.useMemo)(function() {
    return history || createHashHistory();
  }, [
    history
  ]);
  return React9.createElement(HistoryRouter, { history: finalHistory }, children);
};
...
var useBasename = function() {
  return (0, import_react22.useContext)(BasenameContext);
};
...
var useCreatePath = function() {
  ...
  return (0, import_react23.useCallback)(function(_a) {
...
var useRedirect = function() {
  ...
  return (0, import_react24.useCallback)(function(redirectTo, resource, id, data, state) {
    if (resource === void 0) {
      resource = "";
    }
    if (state === void 0) {
...
var DataProviderContext = (0, import_react26.createContext)(null);
...
var testDataProvider = function(overrides) {
  return __assign4({ getList: function() {
    return Promise.resolve({ data: [], total: 0 });
  }, getOne: function() {
...
var useLogoutIfAccessDenied = function() {
  ...
  var notify = useNotify();
  var navigate = useNavigate();
  var logoutIfAccessDenied = (0, import_react27.useCallback)(function(error, disableNotification) {
...
var useDataProvider = function() {
  var dataProvider = (0, import_react28.useContext)(DataProviderContext_default) || defaultDataProvider2;
  var logoutIfAccessDenied = useLogoutIfAccessDenied_default();
  var dataProviderProxy = (0, import_react28.useMemo)(function() {
...
var useIsDataLoaded = function(queryKey, options) {
  ...
  var _b = (0, import_react29.useState)(function() {
    if (!enabled) {
      return false;
    }
...
var useLoading = function() {
  ...
  var mountedRef = import_react30.default.useRef(false);
  var isFetchingRef = import_react30.default.useRef(client.isFetching() > 0);
  var isMutatingRef = import_react30.default.useRef(client.isMutating() > 0);
  var _a = import_react30.default.useState(isFetchingRef.current || isMutatingRef.current), isLoading = _a[0], setIsLoading = _a[1];
...
var useGetList = function(resource, params, options) {
  ...
  }, __assign6(__assign6({}, options), { onSuccess: function(value) {
    var _a2;
  ...
  return (0, import_react32.useMemo)(function() {
    var _a2, _b2, _c2;
    return result.data ? __assign6(__assign6({}, result), { data: (_a2 = result.data) === null || _a2 === void 0 ? void 0 : _a2.data, total: (_b2 = result.data) === null || _b2 === void 0 ? void 0 : _b2.total, pageInfo: (_c2 = result.data) === null || _c2 === void 0 ? void 0 : _c2.pageInfo }) : result;
  }, [result]);
};
...
var useGetMany = function(resource, params, options) {
  ...
  }, __assign7({ placeholderData: function() {
...
var useGetManyAggregate = function(resource, params, options) {
  ...
  var queryCache = queryClient.getQueryCache();
  var ids = params.ids, meta = params.meta;
  var placeholderData = (0, import_react33.useMemo)(function() {
  ...
  }, __assign8({ placeholderData, onSuccess: function(data) {
...
var useGetManyReference = function(resource, params, options) {
  ...
  }, __assign9({ onSuccess: function(value) {
    var _a2;
    (_a2 = value === null || value === void 0 ? void 0 : value.data) === null || _a2 === void 0 ? void 0 : _a2.forEach(function(record) {
      queryClient.setQueryData([resource, "getOne", { id: String(record.id), meta }], function(oldRecord) {
        return oldRecord !== null && oldRecord !== void 0 ? oldRecord : record;
...
var useFilterState_default = function(_a) {
  ...
  var permanentFilterProp = (0, import_react35.useRef)(permanentFilter);
  var latestValue = (0, import_react35.useRef)();
  var _e = useSafeSetState(__assign10(__assign10({}, permanentFilter), filterToQuery(""))), filter = _e[0], setFilterValue = _e[1];
  ...
  (0, import_react35.useEffect)(function() {
    if (!(0, import_isEqual.default)(permanentFilterProp.current, permanentFilter)) {
      ...
      setFilterValue(__assign10(__assign10({}, permanentFilter), filterToQuery(latestValue.current)));
    }
  }, [permanentFilterSignature, permanentFilterProp, filterToQuery]);
  var setFilter = (0, import_react35.useCallback)(
    (0, import_debounce.default)(function(value) {
      setFilterValue(__assign10(__assign10({}, permanentFilter), filterToQuery(value)));
...
var removeEmpty = function(object) {
  return Object.keys(object).reduce(function(acc, key) {
    ...
    return isEmpty(child) ? acc : __assign11(__assign11({}, acc), (_a = {}, _a[key] = child, _a));
  }, {});
};
  ...
  switch (action.type) {
    case SET_SORT:
      if (action.payload.field === previousState.sort) {
        return __assign12(__assign12({}, previousState), { order: oppositeOrder(previousState.order), page: 1 });
      }
      return __assign12(__assign12({}, previousState), { sort: action.payload.field, order: action.payload.order || SORT_ASC, page: 1 });
    case SET_PAGE:
      return __assign12(__assign12({}, previousState), { page: action.payload });
    case SET_PER_PAGE:
      return __assign12(__assign12({}, previousState), { page: 1, perPage: action.payload });
    case SET_FILTER: {
      return __assign12(__assign12({}, previousState), { page: 1, filter: action.payload.filter, displayedFilters: action.payload.displayedFilters ? action.payload.displayedFilters : previousState.displayedFilters });
    }
    case SHOW_FILTER: {
      if (previousState.displayedFilters && previousState.displayedFilters[action.payload.filterName]) {
        return previousState;
      }
      return __assign12(__assign12({}, previousState), {
        ...
        displayedFilters: __assign12(__assign12({}, previousState.displayedFilters), (_a = {}, _a[action.payload.filterName] = true, _a))
      });
    }
    case HIDE_FILTER: {
      return __assign12(__assign12({}, previousState), {
        ...
        displayedFilters: previousState.displayedFilters ? Object.keys(previousState.displayedFilters).reduce(function(filters, filter) {
          var _a2;
          return filter !== action.payload ? __assign12(__assign12({}, filters), (_a2 = {}, _a2[filter] = true, _a2)) : filters;
...
var useSortState = function(initialSort) {
  ...
  var _a = (0, import_react36.useReducer)(sortReducer, initialSort), sort = _a[0], dispatch = _a[1];
  var isFirstRender = (0, import_react36.useRef)(true);
  ...
  return {
    setSort: (0, import_react36.useCallback)(function(sort2) {
      return dispatch({ type: "SET_SORT", payload: sort2 });
    }, [dispatch]),
    setSortField: (0, import_react36.useCallback)(function(field) {
      return dispatch({ type: "SET_SORT_FIELD", payload: field });
    }, [dispatch]),
    setSortOrder: (0, import_react36.useCallback)(function(order) {
...
var paginationReducer = function(prevState, nextState) {
  return __assign13(__assign13({}, prevState), nextState);
};
...
var usePaginationState_default = function(initialPagination) {
  ...
  var _a = (0, import_react37.useReducer)(paginationReducer, __assign13(__assign13({}, defaultPagination), initialPagination)), pagination = _a[0], setPagination = _a[1];
  var isFirstRender = (0, import_react37.useRef)(true);
  var setPerPage = (0, import_react37.useCallback)(function(perPage) {
    return setPagination({ perPage, page: 1 });
  }, []);
  var setPage = (0, import_react37.useCallback)(function(page) {
...
var useDeleteWithUndoController = function(props) {
  ...
  var mutationMeta = mutationOptions.meta, otherMutationOptions = __rest2(mutationOptions, ["meta"]);
  var resource = useResourceContext(props);
  var notify = useNotify();
  var unselect = useUnselect(resource);
  var redirect = useRedirect();
  var _c = useDelete(), deleteOne = _c[0], isLoading = _c[1].isLoading;
  var handleDelete = (0, import_react38.useCallback)(function(event) {
    event.stopPropagation();
    deleteOne(resource, {
      id: record.id,
      previousData: record,
      meta: mutationMeta
    }, __assign14({ onSuccess: function() {
...
var useDeleteWithConfirmController = function(props) {
  ...
  var mutationMeta = mutationOptions.meta, otherMutationOptions = __rest3(mutationOptions, ["meta"]);
  var resource = useResourceContext(props);
  var _b = (0, import_react39.useState)(false), open = _b[0], setOpen = _b[1];
  var notify = useNotify();
  var unselect = useUnselect(resource);
  var redirect = useRedirect();
  var _c = useDelete(), deleteOne = _c[0], isLoading = _c[1].isLoading;
  ...
  var handleDelete = (0, import_react39.useCallback)(function(event) {
    event.stopPropagation();
    deleteOne(resource, {
      id: record.id,
      previousData: record,
      meta: mutationMeta
    }, __assign15({ onSuccess: function() {
      setOpen(false);
      notify("ra.notification.deleted", {
        type: "info",
        messageArgs: { smart_count: 1 },
...
var SaveContext = (0, import_react40.createContext)(void 0);

// node_modules/ra-core/dist/esm/controller/saveContext/SaveContextProvider.js
var React12 = __toESM(require_react());
var SaveContextProvider = function(_a) {
  var children = _a.children, value = _a.value;
  return React12.createElement(SaveContext.Provider, { value }, children);
};
...
var usePickSaveContext = function(context) {
  var value = (0, import_react41.useMemo)(
    function() {
...
var useSaveContext = function(_props) {
  return (0, import_react42.useContext)(SaveContext);
};
...
var useMutationMiddlewares = function() {
  var callbacks = (0, import_react43.useRef)([]);
  var registerMutationMiddleware = (0, import_react43.useCallback)(function(callback) {
    callbacks.current.push(callback);
  }, []);
  var unregisterMutationMiddleware = (0, import_react43.useCallback)(function(callback) {
    callbacks.current = callbacks.current.filter(function(cb) {
      return cb !== callback;
    });
  }, []);
  var getMutateWithMiddlewares = (0, import_react43.useCallback)(function(fn) {
    return function() {
      var _a;
      var args = [];
      for (var _i = 0; _i < arguments.length; _i++) {
  ...
  var functions = (0, import_react43.useMemo)(function() {
    return {
      registerMutationMiddleware,
...
var useCreateController = function(props) {
  ...
  var onSuccess = mutationOptions.onSuccess, onError = mutationOptions.onError, meta = mutationOptions.meta, otherMutationOptions = __rest4(mutationOptions, ["onSuccess", "onError", "meta"]);
  ...
  var _e = useCreate(resource, void 0, __assign16(__assign16({}, otherMutationOptions), { returnPromise: true })), create = _e[0], saving = _e[1].isLoading;
  var save = (0, import_react45.useCallback)(function(data, _a2) {
...
var RecordContext = (0, import_react46.createContext)(void 0);
RecordContext.displayName = "RecordContext";
var RecordContextProvider = function(_a) {
  var children = _a.children, value = _a.value;
  return React13.createElement(RecordContext.Provider, { value }, children);
};

// node_modules/ra-core/dist/esm/controller/create/CreateContext.js
var import_react47 = __toESM(require_react());
var CreateContext = (0, import_react47.createContext)({
  record: null,
  defaultTitle: null,
  isFetching: null,
  isLoading: null,
...
var CreateContextProvider = function(_a) {
  ...
  return React14.createElement(
    ...
    React14.createElement(
      SaveContextProvider,
      { value: __assign17(__assign17({}, usePickSaveContext(value)), { mutationMode: "pessimistic" }) },
      React14.createElement(RecordContextProvider, { value: value && value.record }, children)
    )
  );
};
...
var CreateBase = function(_a) {
  var children = _a.children, props = __rest5(_a, ["children"]);
  var controllerProps = useCreateController(props);
  var body = React15.createElement(CreateContextProvider, { value: controllerProps }, children);
  return props.resource ? (
    // support resource override via props
    React15.createElement(ResourceContextProvider, { value: props.resource }, body)
  ) : body;
};
...
var CreateController = function(_a) {
  var children = _a.children, props = __rest6(_a, ["children"]);
  var controllerProps = useCreateController(props);
...
var useCreateContext = function(props) {
  var context = (0, import_react48.useContext)(
...
var useEditController = function(props) {
  ...
  var queryMeta = queryOptions.meta, otherQueryOptions = __rest7(queryOptions, ["meta"]);
  var onSuccess = mutationOptions.onSuccess, onError = mutationOptions.onError, mutationMeta = mutationOptions.meta, otherMutationOptions = __rest7(mutationOptions, ["onSuccess", "onError", "meta"]);
  ...
  var _f = useGetOne(resource, { id, meta: queryMeta }, __assign18({ onError: function() {
  ...
  var _g = useUpdate(resource, recordCached, __assign18(__assign18({}, otherMutationOptions), { mutationMode, returnPromise: mutationMode === "pessimistic" })), update = _g[0], saving = _g[1].isLoading;
  var save = (0, import_react49.useCallback)(function(data, _a2) {
    var _b2 = _a2 === void 0 ? {} : _a2, onSuccessFromSave = _b2.onSuccess, onErrorFromSave = _b2.onError, transformFromSave = _b2.transform, metaFromSave = _b2.meta;
          ...
          switch (_b3.label) {
            ...
            case 1:
              ...
              return [4, mutate(resource, { id, data: data2, meta: metaFromSave !== null && metaFromSave !== void 0 ? metaFromSave : mutationMeta }, {
                onSuccess: function(data3, variables, context) {
                  return __awaiter4(void 0, void 0, void 0, function() {
                    return __generator4(this, function(_a4) {
                      if (onSuccessFromSave) {
                        return [2, onSuccessFromSave(data3, variables, context)];
                      }
                      if (onSuccess) {
...
var useRecordContext = function(props) {
  var context = (0, import_react50.useContext)(RecordContext);
...
var WithRecord = function(_a) {
  ...
  return record ? React16.createElement(React16.Fragment, null, render(record)) : null;
};
...
var OptionalRecordContextProvider = function(_a) {
  ...
  return value ? React17.createElement(RecordContextProvider, { value }, children) : children;
};

// node_modules/ra-core/dist/esm/controller/edit/EditContext.js
var import_react51 = __toESM(require_react());
var EditContext = (0, import_react51.createContext)({
  record: null,
  defaultTitle: null,
  isFetching: null,
  isLoading: null,
...
var EditController = function(_a) {
  var children = _a.children, props = __rest9(_a, ["children"]);
  var controllerProps = useEditController(props);
  return children(controllerProps);
};
...
var useEditContext = function(props) {
  var context = (0, import_react52.useContext)(EditContext);
...
var ExporterContext = (0, import_react53.createContext)(defaultExporter_default);
...
var useRecordSelection = function(resource) {
  ...
  var selectionModifiers = (0, import_react54.useMemo)(function() {
    return {
...
function useSafeSetState(initialState) {
  var _a = (0, import_react55.useState)(initialState), state = _a[0], setState = _a[1];
  var mountedRef = (0, import_react55.useRef)(false);
  ...
  var safeSetState = (0, import_react55.useCallback)(function(args) {
    if (mountedRef.current) {
...
function useDeepCompareEffect(callback, inputs) {
  var cleanupRef = (0, import_react55.useRef)();
  (0, import_react55.useEffect)(function() {
...
function useIsMounted() {
  var isMounted = (0, import_react55.useRef)(true);
  (0, import_react55.useEffect)(function() {
...
var useListParams = function(_a) {
  ...
  var location = useLocation();
  var navigate = useNavigate();
  var _g = (0, import_react56.useState)(defaultParams), localParams = _g[0], setLocalParams = _g[1];
  var _h = useStore(storeKey || "".concat(resource, ".listParams"), defaultParams), params = _h[0], setParams = _h[1];
  var tempParams = (0, import_react56.useRef)();
  ...
  var query = (0, import_react56.useMemo)(
    function() {
      return getQuery({
        queryFromLocation,
  ...
  var changeParams = (0, import_react56.useCallback)(function(action) {
    ...
    if (!tempParams.current) {
      ...
      setTimeout(function() {
        if (disableSyncWithLocation) {
          ...
          navigate({
            search: "?".concat((0, import_query_string3.stringify)(__assign19(__assign19({}, tempParams.current), { filter: JSON.stringify(tempParams.current.filter), displayedFilters: JSON.stringify(tempParams.current.displayedFilters) })))
          }, {
            state: {
  ...
  var setSort = (0, import_react56.useCallback)(function(sort2) {
    return changeParams({
      type: SET_SORT,
      payload: sort2
    });
  }, [changeParams]);
  var setPage = (0, import_react56.useCallback)(function(newPage) {
    return changeParams({ type: SET_PAGE, payload: newPage });
  }, [changeParams]);
  var setPerPage = (0, import_react56.useCallback)(function(newPerPage) {
  ...
  var setFilters = (0, import_react56.useCallback)(
  ...
  var hideFilter = (0, import_react56.useCallback)(function(filterName) {
    changeParams({
      type: HIDE_FILTER,
      payload: filterName
    });
  }, [changeParams]);
  var showFilter = (0, import_react56.useCallback)(function(filterName, defaultValue) {
    changeParams({
      type: SHOW_FILTER,
      payload: {
        filterName,
  ...
  return [
    __assign19({ displayedFilters: displayedFilterValues, filterValues, requestSignature }, query),
    {
      changeParams,
      setPage,
      setPerPage,
...
var getQuery = function(_a) {
  ...
  var query = Object.keys(queryFromLocation).length > 0 ? queryFromLocation : hasCustomParams(params) ? __assign19({}, params) : { filter: filterDefaultValues || {} };
  if (!query.sort) {
  ...
  return __assign19(__assign19({}, query), { page: getNumberOrDefault(query.page, 1), perPage: getNumberOrDefault(query.perPage, 10) });
};
...
var useInfiniteListController = function(props) {
  ...
  useAuthenticated({ enabled: !disableAuthentication });
  var resource = useResourceContext(props);
  var meta = queryOptions.meta, otherQueryOptions = __rest10(queryOptions, ["meta"]);
  if (!resource) {
  ...
  if (filter && (0, import_react57.isValidElement)(filter)) {
  ...
  var _g = useInfiniteGetList(resource, {
    ...
    filter: __assign20(__assign20({}, query.filter), filter),
    meta
  }, __assign20({ keepPreviousData: true, retry: false, onError: function(error2) {
  ...
  var currentSort = (0, import_react57.useMemo)(function() {
    return {
      field: query.sort,
      order: query.order
    };
  ...
  var unwrappedData = (0, import_react57.useMemo)(function() {
    var _a2;
...
var ListFilterContext = (0, import_react59.createContext)({
  displayedFilters: null,
  filterValues: null,
  hideFilter: null,
  setFilters: null,
...
var ListSortContext = (0, import_react60.createContext)({
  sort: null,
  setSort: null,
  resource: null
});
...
var ListPaginationContext = (0, import_react61.createContext)({
  isLoading: null,
  page: null,
  perPage: null,
  setPage: null,
  ...
  return React20.createElement(
    ...
    React20.createElement(
      ...
      React20.createElement(
        ...
        React20.createElement(ListPaginationContext.Provider, { value: usePickPaginationContext(value) }, children)
      )
    )
  );
};
...
var InfinitePaginationContext = (0, import_react62.createContext)({
  hasNextPage: null,
  fetchNextPage: null,
...
var InfiniteListBase = function(_a) {
  ...
  return React21.createElement(
    ...
    React21.createElement(
      ...
      React21.createElement(InfinitePaginationContext.Provider, { value: {
...
var useListController = function(props) {
  ...
  if (filter && (0, import_react63.isValidElement)(filter)) {
  ...
  var _h = useGetList(resource, {
    ...
    sort: { field: query.sort, order: query.order },
    filter: __assign21(__assign21({}, query.filter), filter),
    meta
  }, __assign21({ keepPreviousData: true, retry: false, onError: function(error2) {
    return notify((error2 === null || error2 === void 0 ? void 0 : error2.message) || "ra.notification.http_error", {
      type: "error",
      messageArgs: {
        _: error2 === null || error2 === void 0 ? void 0 : error2.message
  ...
  var currentSort = (0, import_react63.useMemo)(function() {
    return {
      field: query.sort,
      order: query.order
    };
...
var getListControllerProps = function(props) {
  return injectedProps.reduce(function(acc, key) {
    var _a;
    return __assign21(__assign21({}, acc), (_a = {}, _a[key] = props[key], _a));
  }, {});
};
...
var ListBase = function(_a) {
  ...
  return React22.createElement(
    ResourceContextProvider,
    { value: props.resource },
    React22.createElement(ListContextProvider, { value: useListController(props) }, children)
  );
};
...
var ListController = function(_a) {
  var children = _a.children, props = __rest14(_a, ["children"]);
...
var useExpanded = function(resource, id, single) {
  ...
  var toggleExpanded = (0, import_react64.useCallback)(function() {
...
var useExpandAll = function(resource, ids) {
  ...
  var toggleExpandedAll = (0, import_react64.useCallback)(function() {
...
var useInfinitePaginationContext = function() {
  return (0, import_react65.useContext)(InfinitePaginationContext);
};
...
var useList = function(props) {
  ...
  var filterRef = (0, import_react66.useRef)(filter);
  ...
  var hideFilter = (0, import_react66.useCallback)(function(filterName) {
    setDisplayedFilters(function(previousState) {
      var _a2 = previousState, _b2 = filterName, _ = _a2[_b2], newState = __rest15(_a2, [typeof _b2 === "symbol" ? _b2 : _b2 + ""]);
      return newState;
    });
  ...
  var showFilter = (0, import_react66.useCallback)(function(filterName, defaultValue) {
    setDisplayedFilters(function(previousState) {
      var _a2;
      return __assign22(__assign22({}, previousState), (_a2 = {}, _a2[filterName] = true, _a2));
    });
    setFilterValues(function(previousState) {
      var _a2;
      return removeEmpty_default(__assign22(__assign22({}, previousState), (_a2 = {}, _a2[filterName] = defaultValue, _a2)));
    });
  }, [setDisplayedFilters, setFilterValues]);
  var setFilters = (0, import_react66.useCallback)(function(filters, displayedFilters2) {
...
var useListContext = function(props) {
  var context = (0, import_react67.useContext)(ListContext);
  return (0, import_react67.useMemo)(function() {
...
var useListFilterContext = function(props) {
  var context = (0, import_react68.useContext)(ListFilterContext);
...
var useListPaginationContext = function(props) {
  var context = (0, import_react69.useContext)(ListPaginationContext);
...
var useListSortContext = function(props) {
  var context = (0, import_react70.useContext)(ListSortContext);
  if (!context.setSort) {
    if (true) {
      console.log("List components must be used inside a <ListContextProvider>. Relying on props rather than context to get List data and callbacks is deprecated and won't be supported in the next major version of react-admin.");
    }
...
var useUnselect = function(resource) {
  ...
  return (0, import_react71.useCallback)(function(ids) {
    unselect(ids);
  }, [unselect]);
};
...
var useUnselectAll = function(resource) {
  ...
  return (0, import_react72.useCallback)(function() {
    clearSelection();
  }, [clearSelection]);
};
...
var useReferenceArrayFieldController = function(props) {
  ...
  var ids = (0, import_react73.useMemo)(function() {
    if (Array.isArray(value))
      return value;
  ...
  return __assign23(__assign23({}, listProps), { defaultTitle: null, refetch: refetch2, resource: reference });
};
...
var useReferenceManyFieldController = function(props) {
  ...
  var setSort = (0, import_react74.useCallback)(function(sort2) {
    setSortState(sort2);
    setPage(1);
  }, [setPage, setSortState]);
  ...
  var filterRef = (0, import_react74.useRef)(filter);
  ...
  var hideFilter = (0, import_react74.useCallback)(function(filterName) {
    setDisplayedFilters(function(previousState) {
      var _a2 = previousState, _b2 = filterName, _ = _a2[_b2], newState = __rest16(_a2, [typeof _b2 === "symbol" ? _b2 : _b2 + ""]);
      return newState;
    });
    setFilterValues(function(previousState) {
      var _a2 = previousState, _b2 = filterName, _ = _a2[_b2], newState = __rest16(_a2, [typeof _b2 === "symbol" ? _b2 : _b2 + ""]);
  ...
  var showFilter = (0, import_react74.useCallback)(function(filterName, defaultValue) {
    setDisplayedFilters(function(previousState) {
      var _a2;
      return __assign24(__assign24({}, previousState), (_a2 = {}, _a2[filterName] = true, _a2));
    });
    setFilterValues(function(previousState) {
      var _a2;
      return __assign24(__assign24({}, previousState), (_a2 = {}, _a2[filterName] = defaultValue, _a2));
    });
  }, [setDisplayedFilters, setFilterValues]);
  var setFilters = (0, import_react74.useCallback)(function(filters, displayedFilters2) {
    setFilterValues(removeEmpty_default(filters));
    setDisplayedFilters(displayedFilters2);
    setPage(1);
  }, [setDisplayedFilters, setFilterValues, setPage]);
...
var useReferenceOneFieldController = function(props) {
  ...
  var notify = useNotify();
  var meta = queryOptions.meta, otherQueryOptions = __rest17(queryOptions, ["meta"]);
  var _e = useGetManyReference(reference, {
    ...
    filter,
    meta
  }, __assign25({ enabled: !!record, onError: function(error2) {
    return notify(typeof error2 === "string" ? error2 : error2.message || "ra.notification.http_error", {
      type: "error",
      messageArgs: {
        _: typeof error2 === "string" ? error2 : error2 && error2.message ? error2.message : void 0
...
var HookFormContext = import_react75.default.createContext(null);
var useFormContext = () => import_react75.default.useContext(HookFormContext);
var FormProvider = (props) => {
  const { children, ...data } = props;
  return import_react75.default.createElement(HookFormContext.Provider, { value: data }, children);
};
...
function useSubscribe(props) {
  const _props = import_react75.default.useRef(props);
...
function useFormState(props) {
  ...
  const [formState, updateFormState] = import_react75.default.useState(control._formState);
  const _mounted = import_react75.default.useRef(true);
  const _localProxyFormState = import_react75.default.useRef({
    isDirty: false,
    isLoading: false,
    dirtyFields: false,
    touchedFields: false,
  ...
  const _name = import_react75.default.useRef(name);
  _name.current = name;
  useSubscribe({
    disabled,
...
function useWatch(props) {
  ...
  const [value, updateValue] = import_react75.default.useState(control._getWatch(name, defaultValue));
  import_react75.default.useEffect(() => control._removeUnmounted());
  return value;
}
...
function useController(props) {
  ...
  const _registerProps = import_react75.default.useRef(control.register(name, {
    ...props.rules,
    value
  }));
  ...
  return {
    field: {
      name,
      value,
      onChange: import_react75.default.useCallback((event) => _registerProps.current.onChange({
        target: {
      ...
      onBlur: import_react75.default.useCallback(() => _registerProps.current.onBlur({
        target: {
...
function useFieldArray(props) {
  ...
  const [fields, setFields] = import_react75.default.useState(control._getFieldArray(name));
  const ids = import_react75.default.useRef(control._getFieldArray(name).map(generateId));
  const _fieldIds = import_react75.default.useRef(fields);
  const _name = import_react75.default.useRef(name);
  const _actioned = import_react75.default.useRef(false);
  _name.current = name;
  ...
  const updateValues = import_react75.default.useCallback((updatedFieldArrayValues) => {
  ...
  return {
    swap: import_react75.default.useCallback(swap, [updateValues, name, control]),
    move: import_react75.default.useCallback(move, [updateValues, name, control]),
    prepend: import_react75.default.useCallback(prepend$1, [updateValues, name, control]),
    append: import_react75.default.useCallback(append$1, [updateValues, name, control]),
    remove: import_react75.default.useCallback(remove, [updateValues, name, control]),
    insert: import_react75.default.useCallback(insert$1, [updateValues, name, control]),
    update: import_react75.default.useCallback(update, [updateValues, name, control]),
    replace: import_react75.default.useCallback(replace, [updateValues, name, control]),
    fields: import_react75.default.useMemo(() => fields.map((field, index) => ({
      ...field,
...
function useForm(props = {}) {
  const _formControl = import_react75.default.useRef();
  const _values = import_react75.default.useRef();
  const [formState, updateFormState] = import_react75.default.useState({
    isDirty: false,
    isValidating: false,
...
var useReferenceParams = function(_a) {
  ...
  var _f = (0, import_react76.useState)(defaultParams2), params = _f[0], setParams = _f[1];
  var tempParams = (0, import_react76.useRef)();
  var requestSignature = [
    resource,
  ...
  var query = (0, import_react76.useMemo)(
    function() {
      return getQuery2({
        params,
  ...
  var changeParams = (0, import_react76.useCallback)(function(action) {
    if (!tempParams.current) {
  ...
  var setSort = (0, import_react76.useCallback)(
    function(sort2) {
      return changeParams({
        type: SET_SORT,
        payload: sort2
  ...
  var setPage = (0, import_react76.useCallback)(
    function(newPage) {
      return changeParams({ type: SET_PAGE, payload: newPage });
    },
    requestSignature
  ...
  var setPerPage = (0, import_react76.useCallback)(
    function(newPerPage) {
      return changeParams({ type: SET_PER_PAGE, payload: newPerPage });
    },
    requestSignature
  ...
  var debouncedSetFilters = (0, import_react76.useRef)((0, import_debounce3.default)(function(filter2, displayedFilters) {
    changeParams({
      type: SET_FILTER,
      payload: {
  ...
  var setFilters = (0, import_react76.useCallback)(
  ...
  return [
    __assign26({ displayedFilters: displayedFilterValues, filterValues, requestSignature }, query),
    {
      changeParams,
      setPage,
      setPerPage,
...
var getQuery2 = function(_a) {
  ...
  var query = hasCustomParams2(params) ? __assign26({}, params) : { filter: filterDefaultValues || {} };
  if (!query.sort) {
    query.sort = sort.field;
    query.order = sort.order;
  }
  ...
  return __assign26(__assign26({}, query), { page: getNumberOrDefault2(query.page, 1), perPage: getNumberOrDefault2(query.perPage, 10) });
};
...
var useReferenceArrayInputController = function(props) {
  ...
  var meta = queryOptions.meta, otherQueryOptions = __rest18(queryOptions, ["meta"]);
  ...
  var _h = useGetList(reference, {
    ...
    filter: __assign27(__assign27({}, params.filter), filter),
    meta
  }, __assign27({ retry: false, enabled: isGetMatchingEnabled, keepPreviousData: true }, otherQueryOptions)), matchingReferences = _h.data, total = _h.total, pageInfo = _h.pageInfo, errorGetList = _h.error, isLoadingGetList = _h.isLoading, isFetchingGetList = _h.isFetching, refetchGetMatching = _h.refetch;
  ...
  var refetch2 = (0, import_react77.useCallback)(function() {
    refetchGetMany();
    refetchGetMatching();
  }, [refetchGetMany, refetchGetMatching]);
  var currentSort = (0, import_react77.useMemo)(function() {
    return {
      field: params.sort,
      order: params.order
    };
...
var useReference = function(_a) {
  ...
  var meta = options.meta, otherQueryOptions = __rest19(options, ["meta"]);
...
var useReferenceInputController = function(props) {
  ...
  var _e = useGetList(reference, {
    ...
    sort: { field: params.sort, order: params.order },
    filter: __assign28(__assign28({}, params.filter), filter),
    meta
  }, __assign28({ enabled: isGetMatchingEnabled, keepPreviousData: true }, otherQueryOptions)), _f = _e.data, possibleValuesData = _f === void 0 ? [] : _f, total = _e.total, pageInfo = _e.pageInfo, possibleValuesFetching = _e.isFetching, possibleValuesLoading = _e.isLoading, possibleValuesError = _e.error, refetchGetList = _e.refetch;
  var _g = useReference({
    id: currentValue,
    reference,
    options: {
  ...
  var _h = (0, import_react78.useState)(null), referenceRecord = _h[0], setReferenceRecord = _h[1];
  ...
  var refetch2 = (0, import_react78.useCallback)(function() {
    refetchGetList();
    refetchReference();
  }, [refetchGetList, refetchReference]);
  var currentSort = (0, import_react78.useMemo)(function() {
    return {
      field: params.sort,
      order: params.order
    };
...
var useShowController = function(props) {
  ...
  var routeId = useParams().id;
  var id = propsId != null ? propsId : decodeURIComponent(routeId);
  var meta = queryOptions.meta, otherQueryOptions = __rest21(queryOptions, ["meta"]);
  var _b = useGetOne(resource, { id, meta }, __assign29({ onError: function() {
    notify("ra.notification.item_doesnt_exist", {
      type: "error"
    });
    redirect("list", resource);
...
var ShowContext = (0, import_react79.createContext)({
  record: null,
  defaultTitle: null,
  isFetching: null,
  isLoading: null,
...
var ShowBase = function(_a) {
  var children = _a.children, props = __rest22(_a, ["children"]);
  var controllerProps = useShowController(props);
  var body = React25.createElement(ShowContextProvider, { value: controllerProps }, children);
  return props.resource ? (
    // support resource override via props
...
var useShowContext = function(props) {
  var context = (0, import_react80.useContext)(ShowContext);
...
var useCreate = function(resource, params, options) {
  ...
  var dataProvider = useDataProvider();
  var queryClient = useQueryClient();
  var paramsRef = (0, import_react81.useRef)(params);
  ...
  }, __assign30(__assign30({}, options), { onSuccess: function(data, variables, context) {
    if (variables === void 0) {
      variables = {};
    }
  ...
  var create = function(callTimeResource, callTimeParams, createOptions) {
    ...
    var _a = createOptions.returnPromise, returnPromise = _a === void 0 ? options.returnPromise : _a, reactCreateOptions = __rest24(createOptions, ["returnPromise"]);
    if (returnPromise) {
      return mutation.mutateAsync(__assign30({ resource: callTimeResource }, callTimeParams), createOptions);
    }
    mutation.mutate(__assign30({ resource: callTimeResource }, callTimeParams), reactCreateOptions);
  };
...
var useUpdate = function(resource, params, options) {
  ...
  var _a = options.mutationMode, mutationMode = _a === void 0 ? "pessimistic" : _a, reactMutationOptions = __rest25(options, ["mutationMode"]);
  var mode = (0, import_react82.useRef)(mutationMode);
  var paramsRef = (0, import_react82.useRef)(params);
  var snapshot = (0, import_react82.useRef)([]);
  var updateCache = function(_a2) {
    ...
    var updateColl = function(old) {
      ...
      return __spreadArray13(__spreadArray13(__spreadArray13([], old.slice(0, index), true), [
        __assign31(__assign31({}, old[index]), data2)
      ], false), old.slice(index + 1), true);
    };
    queryClient.setQueryData([resource2, "getOne", { id: String(id2), meta }], function(record) {
      return __assign31(__assign31({}, record), data2);
    }, { updatedAt });
    queryClient.setQueriesData([resource2, "getList"], function(res) {
      return res && res.data ? __assign31(__assign31({}, res), { data: updateColl(res.data) }) : res;
    }, { updatedAt });
    queryClient.setQueriesData([resource2, "getInfiniteList"], function(res) {
      return res && res.pages ? __assign31(__assign31({}, res), { pages: res.pages.map(function(page) {
        return __assign31(__assign31({}, page), { data: updateColl(page.data) });
      }) }) : res;
    }, { updatedAt });
  ...
  }, __assign31(__assign31({}, reactMutationOptions), { onMutate: function(variables) {
      ...
      return __generator5(this, function(_a2) {
        switch (_a2.label) {
          ...
          case 1:
            ...
            return [2, __assign31({ snapshot: snapshot.current }, userContext)];
          case 2:
      ...
      return __generator5(this, function(_e) {
        switch (_e.label) {
          case 0:
            ...
            if (mode.current === "pessimistic") {
              if (returnPromise) {
                return [2, mutation.mutateAsync(__assign31({ resource: callTimeResource }, callTimeParams), { onSuccess, onSettled, onError })];
              }
              return [2, mutation.mutate(__assign31({ resource: callTimeResource }, callTimeParams), { onSuccess, onSettled, onError })];
            }
          ...
          case 1:
            ...
            if (onSuccess) {
              setTimeout(function() {
                return onSuccess(__assign31(__assign31({}, previousRecord), callTimeData), __assign31({ resource: callTimeResource }, callTimeParams), { snapshot: snapshot.current });
              }, 0);
            }
            if (reactMutationOptions.onSuccess) {
              setTimeout(function() {
                return reactMutationOptions.onSuccess(__assign31(__assign31({}, previousRecord), callTimeData), __assign31({ resource: callTimeResource }, callTimeParams), { snapshot: snapshot.current });
              }, 0);
            }
            if (mode.current === "optimistic") {
              return [2, mutation.mutate(__assign31({ resource: callTimeResource }, callTimeParams), { onSettled, onError })];
            } else {
              undoableEventEmitter_default.once("end", function(_a3) {
                ...
                if (isUndo) {
                  ...
                  mutation.mutate(__assign31({ resource: callTimeResource }, callTimeParams), { onSettled, onError });
                }
              });
            }
            return [
...
var useUpdateMany = function(resource, params, options) {
  ...
  var _a = options.mutationMode, mutationMode = _a === void 0 ? "pessimistic" : _a, reactMutationOptions = __rest26(options, ["mutationMode"]);
  var mode = (0, import_react83.useRef)(mutationMode);
  var paramsRef = (0, import_react83.useRef)(params);
  var snapshot = (0, import_react83.useRef)([]);
  var updateCache = function(_a2) {
      ...
      return __generator6(this, function(_b) {
        ...
        updateColl = function(old) {
          ...
          ids2.forEach(function(id) {
            ...
            newCollection = __spreadArray14(__spreadArray14(__spreadArray14([], newCollection.slice(0, index), true), [
              __assign32(__assign32({}, newCollection[index]), data2)
        ...
        ids2.forEach(function(id) {
          return queryClient.setQueryData([resource2, "getOne", { id: String(id), meta: meta2 }], function(record) {
            return __assign32(__assign32({}, record), data2);
          }, { updatedAt });
        });
        queryClient.setQueriesData([resource2, "getList"], function(res) {
          return res && res.data ? __assign32(__assign32({}, res), { data: updateColl(res.data) }) : res;
        }, { updatedAt });
        queryClient.setQueriesData([resource2, "getInfiniteList"], function(res) {
          return res && res.pages ? __assign32(__assign32({}, res), { pages: res.pages.map(function(page) {
            return __assign32(__assign32({}, page), { data: updateColl(page.data) });
          }) }) : res;
        }, { updatedAt });
        queryClient.setQueriesData([resource2, "getMany"], function(coll) {
          return coll && coll.length > 0 ? updateColl(coll) : coll;
  ...
  }, __assign32(__assign32({}, reactMutationOptions), { onMutate: function(variables) {
    return __awaiter6(void 0, void 0, void 0, function() {
      var userContext;
      return __generator6(this, function(_a2) {
        switch (_a2.label) {
          ...
          case 1:
            userContext = _a2.sent() || {};
            return [2, __assign32({ snapshot: snapshot.current }, userContext)];
          case 2:
            return [2, { snapshot: snapshot.current }];
        }
      });
      ...
      return __generator6(this, function(_d) {
        switch (_d.label) {
          case 0:
            ...
            if (mode.current === "pessimistic") {
              if (returnPromise) {
                return [2, mutation.mutateAsync(__assign32({ resource: callTimeResource }, callTimeParams), { onSuccess, onSettled, onError })];
              }
              return [2, mutation.mutate(__assign32({ resource: callTimeResource }, callTimeParams), { onSuccess, onSettled, onError })];
            }
          ...
          case 2:
            ...
            if (onSuccess) {
              setTimeout(function() {
                return onSuccess(callTimeIds, __assign32({ resource: callTimeResource }, callTimeParams), { snapshot: snapshot.current });
              }, 0);
            }
            if (reactMutationOptions.onSuccess) {
              setTimeout(function() {
                return reactMutationOptions.onSuccess(callTimeIds, __assign32({ resource: callTimeResource }, callTimeParams), { snapshot: snapshot.current });
              }, 0);
            }
            if (mode.current === "optimistic") {
              return [2, mutation.mutate(__assign32({ resource: callTimeResource }, callTimeParams), { onSettled, onError })];
            } else {
              undoableEventEmitter_default.once("end", function(_a3) {
                var isUndo = _a3.isUndo;
                if (isUndo) {
                  ...
                  mutation.mutate(__assign32({ resource: callTimeResource }, callTimeParams), { onSettled, onError });
                }
              });
            }
            return [
...
var useDelete = function(resource, params, options) {
  ...
  var mode = (0, import_react84.useRef)(mutationMode);
  var paramsRef = (0, import_react84.useRef)(params);
  var snapshot = (0, import_react84.useRef)([]);
  var updateCache = function(_a2) {
    ...
    queryClient.setQueriesData([resource2, "getInfiniteList"], function(res) {
      if (!res || !res.pages)
        return res;
      return __assign33(__assign33({}, res), { pages: res.pages.map(function(page) {
        var newCollection = updateColl(page.data);
        var recordWasFound = newCollection.length < page.data.length;
        return recordWasFound ? __assign33(__assign33({}, page), { data: newCollection, total: page.total ? page.total - 1 : void 0, pageInfo: page.pageInfo }) : page;
      }) });
    }, { updatedAt });
    queryClient.setQueriesData([resource2, "getMany"], function(coll) {
      return coll && coll.length > 0 ? updateColl(coll) : coll;
  ...
  }, __assign33(__assign33({}, reactMutationOptions), { onMutate: function(variables) {
    return __awaiter7(void 0, void 0, void 0, function() {
      ...
      return __generator7(this, function(_a2) {
        switch (_a2.label) {
          ...
          case 1:
            userContext = _a2.sent() || {};
            return [2, __assign33({ snapshot: snapshot.current }, userContext)];
          case 2:
            return [2, { snapshot: snapshot.current }];
        }
      });
      ...
      return __generator7(this, function(_c) {
        switch (_c.label) {
          case 0:
            ...
            if (mode.current === "pessimistic") {
              return [2, mutation.mutate(__assign33({ resource: callTimeResource }, callTimeParams), { onSuccess, onSettled, onError })];
            }
          ...
          case 1:
            ...
            if (onSuccess) {
              setTimeout(function() {
                return onSuccess(callTimePreviousData, __assign33({ resource: callTimeResource }, callTimeParams), { snapshot: snapshot.current });
              }, 0);
            }
            if (reactMutationOptions.onSuccess) {
              setTimeout(function() {
                return reactMutationOptions.onSuccess(callTimePreviousData, __assign33({ resource: callTimeResource }, callTimeParams), { snapshot: snapshot.current });
              }, 0);
            }
            if (mode.current === "optimistic") {
              return [2, mutation.mutate(__assign33({ resource: callTimeResource }, callTimeParams), { onSettled, onError })];
            } else {
              undoableEventEmitter_default.once("end", function(_a3) {
                var isUndo = _a3.isUndo;
                if (isUndo) {
                  ...
                  mutation.mutate(__assign33({ resource: callTimeResource }, callTimeParams), { onSettled, onError });
                }
              });
            }
            return [
...
var useDeleteMany = function(resource, params, options) {
  ...
  var mode = (0, import_react85.useRef)(mutationMode);
  var paramsRef = (0, import_react85.useRef)({});
  var snapshot = (0, import_react85.useRef)([]);
  var updateCache = function(_a2) {
    ...
    queryClient.setQueriesData([resource2, "getInfiniteList"], function(res) {
      if (!res || !res.pages)
        return res;
      return __assign34(__assign34({}, res), { pages: res.pages.map(function(page) {
        var newCollection = updateColl(page.data);
        var recordWasFound = newCollection.length < page.data.length;
        return recordWasFound ? __assign34(__assign34({}, page), { data: newCollection, total: page.total ? page.total - (page.data.length - newCollection.length) : void 0, pageInfo: page.pageInfo }) : page;
      }) });
    }, { updatedAt });
    queryClient.setQueriesData([resource2, "getMany"], function(coll) {
      return coll && coll.length > 0 ? updateColl(coll) : coll;
  ...
  }, __assign34(__assign34({}, reactMutationOptions), { onMutate: function(variables) {
    return __awaiter8(void 0, void 0, void 0, function() {
      ...
      return __generator8(this, function(_a2) {
        switch (_a2.label) {
          ...
          case 1:
            userContext = _a2.sent() || {};
            return [2, __assign34({ snapshot: snapshot.current }, userContext)];
          case 2:
            return [2, { snapshot: snapshot.current }];
        }
      });
      ...
      return __generator8(this, function(_b) {
        switch (_b.label) {
          case 0:
            ...
            if (mode.current === "pessimistic") {
              return [2, mutation.mutate(__assign34({ resource: callTimeResource }, callTimeParams), { onSuccess, onSettled, onError })];
            }
          ...
          case 1:
            ...
            if (onSuccess) {
              setTimeout(function() {
                return onSuccess(callTimeIds, __assign34({ resource: callTimeResource }, callTimeParams), { snapshot: snapshot.current });
              }, 0);
            }
            if (reactMutationOptions.onSuccess) {
              setTimeout(function() {
                return reactMutationOptions.onSuccess(callTimeIds, __assign34({ resource: callTimeResource }, callTimeParams), { snapshot: snapshot.current });
              }, 0);
            }
            if (mode.current === "optimistic") {
              return [2, mutation.mutate(__assign34({ resource: callTimeResource }, callTimeParams), { onSettled, onError })];
            } else {
              undoableEventEmitter_default.once("end", function(_a3) {
                var isUndo = _a3.isUndo;
                if (isUndo) {
                  ...
                  mutation.mutate(__assign34({ resource: callTimeResource }, callTimeParams), { onSettled, onError });
                }
              });
            }
            return [
...
var useInfiniteGetList = function(resource, params, options) {
  ...
  }, __assign35(__assign35({ onSuccess: function(data) {
  ...
  return result.data ? __assign35(__assign35({}, result), { data: result.data, total: ((_b = (_a = result.data) === null || _a === void 0 ? void 0 : _a.pages[0]) === null || _b === void 0 ? void 0 : _b.total) || void 0 }) : result;
};
...
var PreferencesEditorContext = (0, import_react86.createContext)(void 0);

// node_modules/ra-core/dist/esm/preferences/PreferencesEditorContextProvider.js
var PreferencesEditorContextProvider = function(_a) {
  var children = _a.children;
  var _b = (0, import_react87.useState)(false), isEnabled = _b[0], setIsEnabled = _b[1];
  var _c = (0, import_react87.useState)(null), editor = _c[0], setEditor = _c[1];
  var _d = (0, import_react87.useState)(), preferenceKey = _d[0], setPreferenceKey = _d[1];
  var _e = (0, import_react87.useState)(null), path = _e[0], setPath = _e[1];
  var _f = (0, import_react87.useState)(null), title = _f[0], setTitleString = _f[1];
  var _g = (0, import_react87.useState)(), titleOptions = _g[0], setTitleOptions = _g[1];
  var enable = (0, import_react87.useCallback)(function() {
    return setIsEnabled(true);
  }, []);
  var disable = (0, import_react87.useCallback)(function() {
    setIsEnabled(false);
    setEditor(null);
  }, []);
  var setTitle = (0, import_react87.useCallback)(function(title2, titleOptions2) {
    setTitleString(title2);
    setTitleOptions(titleOptions2);
  }, []);
  var context = (0, import_react87.useMemo)(function() {
    return {
      editor,
      setEditor,
      preferenceKey,
  ...
  return React26.createElement(PreferencesEditorContext.Provider, { value: context }, children);
};
...
var ResourceDefinitionContext = (0, import_react88.createContext)({
  definitions: {},
  register: function() {
  },
  unregister: function() {
...
var ResourceDefinitionContextProvider = function(_a) {
  ...
  var _c = (0, import_react88.useState)(defaultDefinitions), definitions = _c[0], setState = _c[1];
  var register = (0, import_react88.useCallback)(function(config) {
    setState(function(prev) {
      var _a2;
      return (0, import_isEqual5.default)(prev[config.name], config) ? prev : __assign36(__assign36({}, prev), (_a2 = {}, _a2[config.name] = config, _a2));
    });
  }, []);
  var unregister = (0, import_react88.useCallback)(function(config) {
    setState(function(prev) {
      var _a2 = prev, _b2 = config.name, _ = _a2[_b2], rest = __rest29(_a2, [typeof _b2 === "symbol" ? _b2 : _b2 + ""]);
      return rest;
    });
  }, []);
  var contextValue = (0, import_react88.useMemo)(
    function() {
  ...
  return React27.createElement(ResourceDefinitionContext.Provider, { value: contextValue }, children);
};
...
var CoreAdminContext = function(props) {
  ...
  var finalQueryClient = (0, import_react89.useMemo)(function() {
    return queryClient || new QueryClient();
  }, [
    queryClient
  ]);
  var finalAuthProvider = (0, import_react89.useMemo)(function() {
    return authProvider instanceof Function ? convertLegacyAuthProvider_default(authProvider) : authProvider;
  }, [authProvider]);
  var finalDataProvider = (0, import_react89.useMemo)(function() {
            ...
            React28.createElement(
              ...
              React28.createElement(
                ...
                React28.createElement(
                  ...
                  null,
                  React28.createElement(ResourceDefinitionContextProvider, null, children)
                )
              )
            )
          )
...
var useResourceDefinitionContext = function() {
  return (0, import_react90.useContext)(ResourceDefinitionContext);
};
...
var useRoutesAndResourcesFromChildren = function(children, permissions, isLoading) {
  ...
  var _b = useSafeSetState(function() {
    return getStatus(__assign37({ children }, routesAndResources));
...
var useRoutesAndResourcesState = function(initialState) {
  var _a = (0, import_react91.useState)(initialState), routesAndResources = _a[0], setRoutesAndResources = _a[1];
  var mergeRoutesAndResources = (0, import_react91.useCallback)(function(newRoutesAndResources) {
...
var getRoutesAndResourceFromNodes = function(children) {
  ...
  var resources = [];
  import_react91.Children.forEach(children, function(element) {
    if (!React29.isValidElement(element)) {
      return;
    }
    if (element.type === import_react91.Fragment) {
...
var CoreAdminRoutes = function(props) {
  ...
  var _b = (0, import_react92.useState)(!requireAuth), canRender = _b[0], setCanRender = _b[1];
  ...
  if (status === "empty") {
    return React30.createElement(Ready, null);
  }
  if (status === "loading" || !canRender) {
    return React30.createElement(
      ...
      null,
      customRoutesWithoutLayout,
      oneSecondHasPassed ? React30.createElement(Route, { path: "*", element: React30.createElement(LoadingPage, null) }) : React30.createElement(Route, { path: "*", element: null })
    );
  }
  return React30.createElement(
    Routes,
    null,
    customRoutesWithoutLayout,
    React30.createElement(Route, { path: "/*", element: React30.createElement(
      "div",
      null,
      React30.createElement(
        ...
        React30.createElement(
          ...
          null,
          customRoutesWithLayout,
          import_react92.Children.map(resources, function(resource) {
            return React30.createElement(Route, { key: resource.props.name, path: "".concat(resource.props.name, "/*"), element: resource });
          }),
          React30.createElement(Route, { path: "/", element: dashboard ? React30.createElement(WithPermissions_default, { authParams: defaultAuthParams2, component: dashboard }) : resources.length > 0 ? React30.createElement(Navigate, { to: createPath2({
            resource: resources[0].props.name,
            type: "list"
          }) }) : null }),
          React30.createElement(Route, { path: "*", element: React30.createElement(CatchAll, { title }) })
        )
      )
    ) })
  );
...
var CoreAdminUI = function(props) {
  ...
  return React31.createElement(
    Routes,
    null,
    LoginPage !== false && LoginPage !== true ? React31.createElement(Route, { path: "/login", element: createOrGetElement(LoginPage) }) : null,
    LoginCallbackPage !== false && LoginCallbackPage !== true ? React31.createElement(Route, { path: "/auth-callback", element: createOrGetElement(LoginCallbackPage) }) : null,
    React31.createElement(Route, { path: "/*", element: React31.createElement(CoreAdminRoutes, { catchAll, dashboard, layout, loading, menu, requireAuth, ready, title }, children) })
  );
};
var createOrGetElement = function(el) {
  return (0, import_react93.isValidElement)(el) ? el : (0, import_react93.createElement)(el);
};
var Noop = function() {
  return null;
};
...
var CoreAdmin = function(props) {
  ...
  return React32.createElement(
    ...
    React32.createElement(CoreAdminUI, { layout, dashboard, disableTelemetry, menu, catchAll, title, loading, loginPage, requireAuth, ready }, children)
  );
};
...
var ResourceContext = (0, import_react94.createContext)(void 0);

// node_modules/ra-core/dist/esm/core/ResourceContextProvider.js
var ResourceContextProvider = function(_a) {
  var children = _a.children, value = _a.value;
  return value ? React33.createElement(ResourceContext.Provider, { value }, children) : children;
};
...
var Resource = function(props) {
  ...
  return React34.createElement(
    ...
    React34.createElement(
      Routes,
      null,
      create && React34.createElement(Route, { path: "create/*", element: getElement(create) }),
      show && React34.createElement(Route, { path: ":id/show/*", element: getElement(show) }),
      edit && React34.createElement(Route, { path: ":id/*", element: getElement(edit) }),
      list && React34.createElement(Route, { path: "/*", element: getElement(list) }),
      props.children
    )
  );
};
var getElement = function(ElementOrComponent) {
  if ((0, import_react95.isValidElement)(ElementOrComponent)) {
    return ElementOrComponent;
  }
  if ((0, import_react_is.isValidElementType)(ElementOrComponent)) {
    return React34.createElement(ElementOrComponent, null);
  }
  return null;
};
...
var useResourceContext = function(props) {
  var context = (0, import_react96.useContext)(ResourceContext);
...
var useResourceDefinition = function(props) {
  ...
  var definition = (0, import_react97.useMemo)(function() {
...
var useGetRecordRepresentation = function(resource) {
  ...
  return (0, import_react98.useCallback)(function(record) {
    if (!record)
      return "";
    ...
    if (React35.isValidElement(recordRepresentation)) {
...
var useTranslate = function() {
  var i18nProvider = useI18nProvider();
  var translate = (0, import_react99.useCallback)(
...
var useTranslateLabel = function() {
  ...
  return (0, import_react100.useCallback)(function(_a) {
...
var useTranslatable = function(options) {
  ...
  var _b = (0, import_react101.useState)(defaultLocale), selectedLocale = _b[0], setSelectedLocale = _b[1];
  var resource = useResourceContext({});
  var translateLabel = useTranslateLabel();
  var context = (0, import_react101.useMemo)(function() {
    return {
...
var useTranslatableContext = function() {
  var context = (0, import_react102.useContext)(TranslatableContext);
  if (!context) {
...
var FieldTitle = function(props) {
  ...
  return React36.createElement(
    ...
    isRequired3 && React36.createElement("span", { "aria-hidden": "true" }, " *")
  );
};
FieldTitle.displayName = "FieldTitle";
var FieldTitle_default = (0, import_react103.memo)(FieldTitle);
...
function useWhyDidYouUpdate(name, props) {
  var previousProps = (0, import_react105.useRef)();
  (0, import_react105.useEffect)(function() {
    if (previousProps.current) {
      var allKeys = Object.keys(__assign39(__assign39({}, previousProps.current), props));
      var changesObj_1 = {};
...
var useLayoutEffect3 = typeof window !== "undefined" ? React38.useLayoutEffect : React38.useEffect;
var useEvent = function(fn) {
  var ref = React38.useRef(function() {
    throw new Error("Cannot call an event handler while rendering.");
  });
  useLayoutEffect3(function() {
    ref.current = fn;
  });
  return (0, import_react106.useCallback)(function() {
    var args = [];
    for (var _i = 0; _i < arguments.length; _i++) {
      args[_i] = arguments[_i];
    }
...
var LabelPrefixContext = (0, import_react107.createContext)("");
...
var useLabelPrefix = function() {
  return (0, import_react108.useContext)(LabelPrefixContext);
};
...
var LabelPrefixContextProvider = function(_a) {
  ...
  return React39.createElement(LabelPrefixContext.Provider, { value: newPrefix }, children);
};
...
var useStore = function(key, defaultValue) {
  ...
  var _b = (0, import_react109.useState)(function() {
...
var useRemoveFromStore = function(hookTimeKey) {
  ...
  return (0, import_react110.useCallback)(function(key) {
...
var useRemoveItemsFromStore = function(hookTimeKeyPrefix) {
  ...
  return (0, import_react111.useCallback)(function(keyPrefix) {
...
var useLogout = function() {
  ...
  var navigate = useNavigate();
  var navigateRef = (0, import_react112.useRef)(navigate);
  var location = useLocation();
  var locationRef = (0, import_react112.useRef)(location);
  var basename = useBasename();
  ...
  var logout = (0, import_react112.useCallback)(function(params, redirectTo, redirectToCurrentLocationAfterLogin) {
    if (params === void 0) {
      params = {};
    }
  ...
  var logoutWithoutProvider = (0, import_react112.useCallback)(function(_) {
    navigate({
      pathname: loginUrl
    }, {
      state: {
...
var useAuthState = function(params, logoutOnFailure, queryOptions) {
  ...
  }, __assign40({ onError: function(error) {
    var loginUrl = removeDoubleSlashes2("".concat(basename, "/").concat(defaultAuthParams.loginUrl));
    if (logoutOnFailure) {
...
var usePermissions = function(params, queryParams) {
  ...
  }, __assign41({ onError: function(error) {
    if (true) {
      console.error(error);
    }
...
var useAuthenticated = function(_a) {
  ...
  var params = _a.params, options = __rest30(_a, ["params"]);
...
var isEmptyChildren = function(children) {
  return import_react115.Children.count(children) === 0;
};
var WithPermissions = function(props) {
  var authParams = props.authParams, children = props.children, render = props.render, component = props.component, staticContext = props.staticContext, rest = __rest31(props, ["authParams", "children", "render", "component", "staticContext"]);
  ...
  if (component) {
    return (0, import_react115.createElement)(component, __assign42({ permissions }, rest));
  }
  if (render) {
    return render(__assign42({ permissions }, rest));
  }
  if (children) {
    return children(__assign42({ permissions }, rest));
  }
};
...
var useLogin = function() {
  ...
  var login = (0, import_react116.useCallback)(function(params, pathName) {
    if (params === void 0) {
      params = {};
    }
  ...
  var loginWithoutProvider = (0, import_react116.useCallback)(function(_, __) {
    resetNotifications();
...
var useGetPermissions = function() {
  var authProvider = useAuthProvider_default();
  var getPermissions = (0, import_react117.useCallback)(function(params) {
    if (params === void 0) {
      params = {};
    }
    return authProvider.getPermissions(params);
...
var useCheckAuth = function() {
  ...
  var basename = useBasename();
  var loginUrl = removeDoubleSlashes2("".concat(basename, "/").concat(defaultAuthParams.loginUrl));
  var checkAuth = (0, import_react118.useCallback)(function(params, logoutOnFailure, redirectTo, disableNotification) {
    if (params === void 0) {
      params = {};
    }
    if (logoutOnFailure === void 0) {
...
var useGetIdentity = function(queryParams) {
  ...
  }, __assign43({ enabled: typeof (authProvider === null || authProvider === void 0 ? void 0 : authProvider.getIdentity) === "function" }, queryParams));
  return (0, import_react119.useMemo)(function() {
...
var useHandleAuthCallback = function(options) {
  ...
  }, __assign44({ retry: false, onSuccess: function(data) {
    var _a;
...
var PreferenceKeyContext = (0, import_react120.createContext)("");
var PreferenceKeyContextProvider = function(_a) {
  var _b = _a.value, value = _b === void 0 ? "" : _b, children = _a.children;
  return React41.createElement(PreferenceKeyContext.Provider, { value }, children);
};
var usePreferenceKey = function() {
  return (0, import_react120.useContext)(PreferenceKeyContext);
};
...
var usePreferencesEditor = function() {
  return (0, import_react121.useContext)(PreferencesEditorContext);
};
...
var usePreferenceInput = function(key, defaultValue) {
  ...
  var _b = (0, import_react122.useState)(valueFromStore), value = _b[0], setValue = _b[1];
...
var FormDataConsumer = function(props) {
  ...
  return React42.createElement(FormDataConsumerView, __assign46({ formData }, props));
};
...
var FormGroupsContext = (0, import_react124.createContext)(void 0);
...
var ValidationError = function(props) {
  ...
  if (error.message) {
    ...
    return React43.createElement(React43.Fragment, null, translate(message, __assign47({ _: message }, args)));
  }
  return React43.createElement(React43.Fragment, null, translate(error, { _: error }));
};
...
var ChoicesContext = (0, import_react125.createContext)(void 0);

// node_modules/ra-core/dist/esm/form/choices/ChoicesContextProvider.js
var React44 = __toESM(require_react());
var ChoicesContextProvider = function(_a) {
  var children = _a.children, value = _a.value;
  return React44.createElement(ChoicesContext.Provider, { value }, children);
};
...
var useChoicesContext = function(options) {
  ...
  var context = (0, import_react126.useContext)(ChoicesContext);
  var _a = useList({
...
var FormGroupsProvider = function(_a) {
  var children = _a.children;
  var formGroups = (0, import_react127.useRef)({});
  var subscribers = (0, import_react127.useRef)({});
  var formContextValue = (0, import_react127.useMemo)(function() {
    return {
      /**
  ...
  return React45.createElement(FormGroupsContext.Provider, { value: formContextValue }, children);
};
...
var useNotifyIsFormInvalid = function(control) {
  ...
  var submitCountRef = (0, import_react128.useRef)(submitCount);
  var notify = useNotify();
...
var useWarnWhenUnsavedChanges = function(enable, formRootPathname, control) {
  var navigator = (0, import_react129.useContext)(NavigationContext).navigator;
  var location = useLocation();
  var translate = useTranslate();
  ...
  var initialLocation = (0, import_react129.useRef)(formRootPathname || location.pathname);
...
var useAugmentedForm = function(props) {
  ...
  var defaultValuesIncludingRecord = (0, import_react130.useMemo)(
    function() {
  ...
  var formRef = (0, import_react130.useRef)(form);
  ...
  var handleSubmit = (0, import_react130.useCallback)(function(values, event) {
  ...
  var formHandleSubmit = (0, import_react130.useCallback)(function(event) {
    ...
    React46.createElement(
      ...
      React46.createElement(
        ...
        React46.createElement(
          FormGroupsProvider,
          null,
          React46.createElement("form", { onSubmit: formHandleSubmit, noValidate, id, className }, children)
        )
      )
    )
  );
...
var FormGroupContext = (0, import_react131.createContext)(void 0);
...
var useFormGroups = function() {
  var context = (0, import_react132.useContext)(FormGroupsContext);
  return context;
};
...
var FormGroupContextProvider = function(_a) {
  ...
  return React47.createElement(FormGroupContext.Provider, { value: name }, children);
};
...
var useChoices = function(_a) {
  ...
  var translate = useTranslate();
  var getChoiceText = (0, import_react135.useCallback)(function(choice) {
    if ((0, import_react135.isValidElement)(optionText)) {
      return React48.createElement(RecordContextProvider, { value: choice }, optionText);
    }
    var choiceName = typeof optionText === "function" ? optionText(choice) : (0, import_get10.default)(choice, optionText);
    return (0, import_react135.isValidElement)(choiceName) ? choiceName : translateChoice ? translate(String(choiceName), { _: choiceName }) : String(choiceName);
  }, [optionText, translate, translateChoice]);
  var getChoiceValue = (0, import_react135.useCallback)(function(choice) {
    return (0, import_get10.default)(choice, optionValue);
  }, [
    optionValue
  ]);
  var getDisableValue = (0, import_react135.useCallback)(function(choice) {
...
var useFormGroup = function(name) {
  ...
  var formGroups = useFormGroups();
  var _b = (0, import_react136.useState)({
    errors: void 0,
    isDirty: false,
    isTouched: false,
    isValid: true
  }), state = _b[0], setState = _b[1];
  var updateGroupState = (0, import_react136.useCallback)(function() {
...
var useFormGroupContext = function() {
  var context = (0, import_react137.useContext)(FormGroupContext);
  return context;
};
...
var useSuggestions = function(_a) {
  ...
  var getSuggestions = (0, import_react139.useCallback)(getSuggestionsFactory({
    allowCreate,
    choices: choices2,
    createText,
    createValue,
...
var defaultMatchSuggestion = function(getChoiceText) {
  return function(filter, suggestion, exact) {
    ...
    var isReactElement = (0, import_react139.isValidElement)(suggestionText);
...
var useUnique = function(options) {
  ...
  var translate = useTranslate();
  var record = useRecordContext();
  var debouncedGetList = (0, import_react140.useRef)(
  ...
  var validateUnique = (0, import_react140.useCallback)(function(callTimeOptions) {
...
var InferredElement = (
  ...
  function() {
    ...
    InferredElement2.prototype.getElement = function(props) {
      ...
      return this.children ? (0, import_react141.createElement)(this.type.component, __assign53(__assign53({}, this.props), props), this.children.length > 0 ? this.children.map(function(child, index) {
        return child.getElement({ key: index });
      }) : this.children.getElement()) : (0, import_react141.createElement)(this.type.component, __assign53(__assign53({}, this.props), props));
    };
...
var DefaultComponent = function() {
  return React49.createElement("span", null, ";");
};
var defaultType = {
...
inflection/lib/inflection.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-IGMLE5KG.js.map
