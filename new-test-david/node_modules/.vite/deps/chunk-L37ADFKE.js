...
function newInterval2(floori, offseti, count6, field) {
  ...
  if (count6) {
    interval.count = function(start2, end) {
      ...
      return Math.floor(count6(t04, t14));
    };
    interval.every = function(step) {
      step = Math.floor(step);
      return !isFinite(step) || !(step > 0) ? null : !(step > 1) ? interval : interval.filter(field ? function(d3) {
...
var e22 = Math.sqrt(2);
function ticks_default2(start2, stop2, count6) {
  ...
  if ((step = tickIncrement2(start2, stop2, count6)) === 0 || !isFinite(step))
    return [];
  if (step > 0) {
...
function tickIncrement2(start2, stop2, count6) {
...
function band2() {
  var scale = ordinal2().unknown(void 0), domain = scale.domain, ordinalRange = scale.range, r0 = 0, r1 = 1, step, bandwidth, round = false, paddingInner = 0, paddingOuter = 0, align = 0.5;
  ...
  function rescale() {
    ...
    var values = range_default2(n5).map(function(i4) {
...
function xyz2lab3(t8) {
  return t8 > t33 ? Math.pow(t8, 1 / 3) : t8 / t23 + t05;
}
function lab2xyz3(t8) {
  return t8 > t15 ? t8 * t8 * t8 : t23 * (t8 - t05);
}
...
var rgb_default3 = function rgbGamma3(y5) {
  ...
  function rgb8(start2, end) {
    var r4 = color7((start2 = rgb4(start2)).r, (end = rgb4(end)).r), g4 = color7(start2.g, end.g), b4 = color7(start2.b, end.b), opacity = nogamma3(start2.opacity, end.opacity);
    return function(t8) {
      start2.r = r4(t8);
      start2.g = g4(t8);
      start2.b = b4(t8);
...
function numberArray_default3(a5, b4) {
  if (!b4)
    b4 = [];
...
function object_default3(a5, b4) {
  var i4 = {}, c9 = {}, k5;
  ...
  for (k5 in b4) {
    if (k5 in a5) {
      i4[k5] = value_default3(a5[k5], b4[k5]);
    } else {
      c9[k5] = b4[k5];
    }
  }
...
function string_default3(a5, b4) {
  var bi = reA3.lastIndex = reB3.lastIndex = 0, am, bm, bs, i4 = -1, s4 = [], q = [];
  a5 = a5 + "", b4 = b4 + "";
  while ((am = reA3.exec(a5)) && (bm = reB3.exec(b4))) {
    if ((bs = bm.index) > bi) {
      bs = b4.slice(bi, bs);
      if (s4[i4])
        s4[i4] += bs;
    ...
    if ((am = am[0]) === (bm = bm[0])) {
      ...
      s4[++i4] = null;
      q.push({ i: i4, x: number_default5(am, bm) });
    }
    bi = reB3.lastIndex;
  }
  if (bi < b4.length) {
...
function value_default3(a5, b4) {
  var t8 = typeof b4, c9;
  return b4 == null || t8 === "boolean" ? constant_default6(b4) : (t8 === "number" ? number_default5 : t8 === "string" ? (c9 = color3(b4)) ? (b4 = c9, rgb_default3) : string_default3 : b4 instanceof color3 ? rgb_default3 : b4 instanceof Date ? date_default3 : isNumberArray3(b4) ? numberArray_default3 : Array.isArray(b4) ? genericArray3 : typeof b4.valueOf !== "function" && typeof b4.toString !== "function" || isNaN(b4) ? object_default3 : number_default5)(a5, b4);
}
...
function hsl7(hue6) {
  return function(start2, end) {
    var h3 = hue6((start2 = hsl6(start2)).h, (end = hsl6(end)).h), s4 = nogamma3(start2.s, end.s), l3 = nogamma3(start2.l, end.l), opacity = nogamma3(start2.opacity, end.opacity);
    return function(t8) {
      start2.h = h3(t8);
      start2.s = s4(t8);
      start2.l = l3(t8);
...
function hcl6(hue6) {
  return function(start2, end) {
    var h3 = hue6((start2 = hcl5(start2)).h, (end = hcl5(end)).h), c9 = nogamma3(start2.c, end.c), l3 = nogamma3(start2.l, end.l), opacity = nogamma3(start2.opacity, end.opacity);
    return function(t8) {
      start2.h = h3(t8);
      start2.c = c9(t8);
      start2.l = l3(t8);
...
function cubehelix6(hue6) {
  return function cubehelixGamma(y5) {
    y5 = +y5;
    function cubehelix12(start2, end) {
      var h3 = hue6((start2 = cubehelix5(start2)).h, (end = cubehelix5(end)).h), s4 = nogamma3(start2.s, end.s), l3 = nogamma3(start2.l, end.l), opacity = nogamma3(start2.opacity, end.opacity);
      return function(t8) {
        start2.h = h3(t8);
        start2.s = s4(t8);
        start2.l = l3(Math.pow(t8, y5));
...
function polymap(domain, range, interpolate2) {
  ...
  return function(x5) {
    var i5 = bisect_default2(domain, x5, 1, j2) - 1;
...
function transformer2() {
  var domain = unit, range = unit, interpolate2 = value_default3, transform, untransform, unknown, clamp2 = identity6, piecewise6, output, input;
  function rescale() {
  ...
  scale.invert = function(y5) {
    return clamp2(untransform((input || (input = piecewise6(range, domain.map(transform), number_default5)))(y5)));
  };
  scale.domain = function(_2) {
  ...
  scale.rangeRound = function(_2) {
    return range = Array.from(_2), interpolate2 = round_default3, rescale();
  };
  scale.clamp = function(_2) {
    return arguments.length ? (clamp2 = _2 ? true : identity6, rescale()) : clamp2 !== identity6;
  };
...
function continuous2() {
  return transformer2()(identity6, identity6);
}
...
function tickFormat2(start2, stop2, count6, specifier) {
  var step = tickStep2(start2, stop2, count6), precision;
  ...
  switch (specifier.type) {
    ...
    case "p":
    case "r": {
      if (specifier.precision == null && !isNaN(precision = precisionRound_default2(step, Math.max(Math.abs(start2), Math.abs(stop2)))))
...
function linearish2(scale) {
  ...
  scale.ticks = function(count6) {
    var d3 = domain();
    return ticks_default2(d3[0], d3[d3.length - 1], count6 == null ? 10 : count6);
  };
  scale.tickFormat = function(count6, specifier) {
    var d3 = domain();
    return tickFormat2(d3[0], d3[d3.length - 1], count6 == null ? 10 : count6, specifier);
  };
  scale.nice = function(count6) {
    ...
    while (maxIter-- > 0) {
      step = tickIncrement2(start2, stop2, count6);
      if (step === prestep) {
        d3[i0] = start2;
        d3[i1] = stop2;
        return domain(d3);
...
function linear5() {
  var scale = continuous2();
  scale.copy = function() {
    return copy3(scale, linear5());
  };
  initRange2.apply(scale, arguments);
...
function nice4(domain, interval) {
  domain = domain.slice();
...
function loggish2(transform) {
  ...
  scale.ticks = function(count6) {
    ...
    if (!(base % 1) && j2 - i4 < n5) {
      ...
      if (z4.length * 2 < n5)
        z4 = ticks_default2(u3, v5, n5);
    } else {
      z4 = ticks_default2(i4, j2, Math.min(j2 - i4, n5)).map(pows);
    }
...
function log2() {
  var scale = loggish2(transformer2()).domain([1, 10]);
  scale.copy = function() {
    return copy3(scale, log2()).base(scale.base());
  };
  initRange2.apply(scale, arguments);
  return scale;
}
...
function symlog2() {
  var scale = symlogish2(transformer2());
  scale.copy = function() {
    return copy3(scale, symlog2()).constant(scale.constant());
  };
  return initRange2.apply(scale, arguments);
}
...
function ticker2(year7, month7, week, day7, hour7, minute7) {
  const tickIntervals = [
    ...
    [minute7, 1, durationMinute3],
    [minute7, 5, 5 * durationMinute3],
    [minute7, 15, 15 * durationMinute3],
    [minute7, 30, 30 * durationMinute3],
    [hour7, 1, durationHour3],
    [hour7, 3, 3 * durationHour3],
    [hour7, 6, 6 * durationHour3],
    [hour7, 12, 12 * durationHour3],
    [day7, 1, durationDay3],
    [day7, 2, 2 * durationDay3],
  ...
  function tickInterval(start2, stop2, count6) {
    ...
    if (i4 === 0)
      return millisecond_default3.every(Math.max(tickStep2(start2, stop2, count6), 1));
    const [t8, step] = tickIntervals[target / tickIntervals[i4 - 1][2] < tickIntervals[i4][2] / target ? i4 - 1 : i4];
    return t8.every(step);
  }
  return [ticks, tickInterval];
...
function calendar2(ticks, tickInterval, year7, month7, week, day7, hour7, minute7, second7, format6) {
  var scale = continuous2(), invert = scale.invert, domain = scale.domain;
  ...
  scale.nice = function(interval) {
    ...
    return interval ? domain(nice4(d3, interval)) : scale;
  };
  scale.copy = function() {
    return copy3(scale, calendar2(ticks, tickInterval, year7, month7, week, day7, hour7, minute7, second7, format6));
  };
  return scale;
}
function time2() {
  return initRange2.apply(calendar2(timeTicks2, timeTickInterval2, year_default3, month_default3, sunday3, day_default3, hour_default3, minute_default3, second_default3, timeFormat2).domain([new Date(2e3, 0, 1), new Date(2e3, 0, 2)]), arguments);
}

// node_modules/@nivo/scales/node_modules/d3-scale/src/utcTime.js
function utcTime2() {
  return initRange2.apply(calendar2(utcTicks2, utcTickInterval2, utcYear_default3, utcMonth_default3, utcSunday3, utcDay_default3, utcHour_default3, utcMinute_default3, second_default3, utcFormat2).domain([Date.UTC(2e3, 0, 1), Date.UTC(2e3, 0, 2)]), arguments);
}
...
var L = function(n5) {
  return function(t8) {
    return K4[n5].forEach(function(n6) {
      n6(t8);
    }), t8;
  };
};
var Q = function(n5) {
  ...
  return function(n6) {
    ...
    if ("native" === r4 || n6 instanceof Date)
      return s4(n6);
    var t9 = c9 ? utcParse2(r4) : timeParse2(r4);
    return s4(t9(n6));
  };
};
var W2 = function(n5, t8, r4, e8) {
  ...
  var T4 = linear5().rangeRound("x" === e8 ? [0, r4] : [r4, 0]).domain(p4 ? [o3, a5] : [a5, o3]).clamp(g4);
...
var Y = function(n5, t8, r4) {
  var e8 = point6().range([0, r4]).domain(t8.all);
  return e8.type = "point", e8;
};
var _ = function(n5, t8, r4, e8) {
  var a5 = n5.round, i4 = void 0 === a5 || a5, o3 = band2().range("x" === e8 ? [0, r4] : [r4, 0]).domain(t8.all).round(i4);
  return nn(o3);
};
var nn = function(n5) {
  var t8 = n5;
...
var rn = function(n5, t8, r4, e8) {
  ...
  var y5 = log2().domain([f3, m4]).rangeRound("x" === e8 ? [0, r4] : [r4, 0]).base(o3).nice();
...
var en = function(n5, t8, r4, e8) {
  ...
  var y5 = symlog2().constant(u3).rangeRound("x" === e8 ? [0, r4] : [r4, 0]).nice();
    ...
    return function(string) {
      ...
      if ("V" in d3) {
        ...
        if ("Z" in d3) {
          ...
          week = day7 > 4 || day7 === 0 ? utcMonday4.ceil(week) : utcMonday4(week);
          week = utcDay_default4.offset(week, (d3.V - 1) * 7);
          d3.y = week.getUTCFullYear();
          d3.m = week.getUTCMonth();
          d3.d = week.getUTCDate() + (d3.w + 6) % 7;
        } else {
          week = localDate3(newDate3(d3.y, 0, 1)), day7 = week.getDay();
          week = day7 > 4 || day7 === 0 ? monday4.ceil(week) : monday4(week);
          week = day_default4.offset(week, (d3.V - 1) * 7);
          d3.y = week.getFullYear();
          d3.m = week.getMonth();
          d3.d = week.getDate() + (d3.w + 6) % 7;
        }
...
function formatDayOfYear3(d3, p4) {
  return pad3(1 + day_default4.count(year_default4(d3), d3), p4, 3);
}
...
function formatWeekNumberSunday3(d3, p4) {
  return pad3(sunday4.count(year_default4(d3) - 1, d3), p4, 2);
}
function dISO3(d3) {
  var day7 = d3.getDay();
  return day7 >= 4 || day7 === 0 ? thursday4(d3) : thursday4.ceil(d3);
}
function formatWeekNumberISO3(d3, p4) {
  d3 = dISO3(d3);
  return pad3(thursday4.count(year_default4(d3), d3) + (year_default4(d3).getDay() === 4), p4, 2);
}
function formatWeekdayNumberSunday3(d3) {
  return d3.getDay();
}
function formatWeekNumberMonday3(d3, p4) {
  return pad3(monday4.count(year_default4(d3) - 1, d3), p4, 2);
}
...
function formatFullYearISO3(d3, p4) {
  var day7 = d3.getDay();
  d3 = day7 >= 4 || day7 === 0 ? thursday4(d3) : thursday4.ceil(d3);
  return pad3(d3.getFullYear() % 1e4, p4, 4);
}
...
function formatUTCDayOfYear3(d3, p4) {
  return pad3(1 + utcDay_default4.count(utcYear_default4(d3), d3), p4, 3);
}
...
function formatUTCWeekNumberSunday3(d3, p4) {
  return pad3(utcSunday4.count(utcYear_default4(d3) - 1, d3), p4, 2);
}
function UTCdISO3(d3) {
  var day7 = d3.getUTCDay();
  return day7 >= 4 || day7 === 0 ? utcThursday4(d3) : utcThursday4.ceil(d3);
}
function formatUTCWeekNumberISO3(d3, p4) {
  d3 = UTCdISO3(d3);
  return pad3(utcThursday4.count(utcYear_default4(d3), d3) + (utcYear_default4(d3).getUTCDay() === 4), p4, 2);
}
function formatUTCWeekdayNumberSunday3(d3) {
  return d3.getUTCDay();
}
function formatUTCWeekNumberMonday3(d3, p4) {
  return pad3(utcMonday4.count(utcYear_default4(d3) - 1, d3), p4, 2);
}
...
function formatUTCFullYearISO3(d3, p4) {
  var day7 = d3.getUTCDay();
  d3 = day7 >= 4 || day7 === 0 ? utcThursday4(d3) : utcThursday4.ceil(d3);
  return pad3(d3.getUTCFullYear() % 1e4, p4, 4);
}
...
var formatTypes_default3 = {
  ...
  "p": function(x5, p4) {
    return formatRounded_default3(x5 * 100, p4);
  },
...
var S = (0, import_react17.memo)(function(t8) {
  var e8, n5 = t8.value, a5 = t8.format, o3 = t8.lineX, l3 = t8.lineY, c9 = t8.onClick, f3 = t8.textBaseline, x5 = t8.textAnchor, d3 = t8.animatedProps, u3 = Ut(), m4 = null != (e8 = null == a5 ? void 0 : a5(n5)) ? e8 : n5, k5 = (0, import_react17.useMemo)(function() {
...
var W3 = (0, import_react17.memo)(function(t8) {
  ...
  return (0, import_jsx_runtime3.jsx)("g", { children: l3(function(t9, e9) {
    return (0, import_react17.createElement)(Y2, v3({}, e9, { key: e9.key, animatedProps: t9 }));
  }) });
});
var B4 = (0, import_react17.memo)(function(t8) {
  var e8 = t8.width, n5 = t8.height, r4 = t8.xScale, a5 = t8.yScale, o3 = t8.xValues, l3 = t8.yValues, s4 = (0, import_react17.useMemo)(function() {
    return !!r4 && P3({ width: e8, height: n5, scale: r4, axis: "x", values: o3 });
  }, [r4, o3, e8, n5]), c9 = (0, import_react17.useMemo)(function() {
...
define_default4(Rgb4, rgb5, extend4(Color4, {
  ...
  clamp() {
    return new Rgb4(clampi(this.r), clampi(this.g), clampi(this.b), clampa(this.opacity));
  },
  displayable() {
    return -0.5 <= this.r && this.r < 255.5 && (-0.5 <= this.g && this.g < 255.5) && (-0.5 <= this.b && this.b < 255.5) && (0 <= this.opacity && this.opacity <= 1);
  },
...
function hsl8(h3, s4, l3, opacity) {
...
define_default4(Hsl4, hsl8, extend4(Color4, {
  brighter(k5) {
    k5 = k5 == null ? brighter4 : Math.pow(brighter4, k5);
  ...
  clamp() {
    return new Hsl4(clamph(this.h), clampt(this.s), clampt(this.l), clampa(this.opacity));
  },
  displayable() {
    return (0 <= this.s && this.s <= 1 || isNaN(this.s)) && (0 <= this.l && this.l <= 1) && (0 <= this.opacity && this.opacity <= 1);
  },
...
function lab7(l3, a5, b4, opacity) {
...
define_default4(Lab4, lab7, extend4(Color4, {
  brighter(k5) {
    return new Lab4(this.l + K5 * (k5 == null ? 1 : k5), this.a, this.b, this.opacity);
  },
  darker(k5) {
    return new Lab4(this.l - K5 * (k5 == null ? 1 : k5), this.a, this.b, this.opacity);
  },
...
function xyz2lab4(t8) {
  return t8 > t34 ? Math.pow(t8, 1 / 3) : t8 / t24 + t08;
}
function lab2xyz4(t8) {
  return t8 > t18 ? t8 * t8 * t8 : t24 * (t8 - t08);
}
...
define_default4(Hcl4, hcl7, extend4(Color4, {
  brighter(k5) {
    return new Hcl4(this.h, this.c, this.l + K5 * (k5 == null ? 1 : k5), this.opacity);
  },
  darker(k5) {
    return new Hcl4(this.h, this.c, this.l - K5 * (k5 == null ? 1 : k5), this.opacity);
  },
...
var ED4 = E5 * D4;
var EB4 = E5 * B5;
var BC_DA4 = B5 * C7 - D4 * A6;
function cubehelixConvert4(o3) {
  if (o3 instanceof Cubehelix4)
    return new Cubehelix4(o3.h, o3.s, o3.l, o3.opacity);
  if (!(o3 instanceof Rgb4))
    o3 = rgbConvert4(o3);
  var r4 = o3.r / 255, g4 = o3.g / 255, b4 = o3.b / 255, l3 = (BC_DA4 * b4 + ED4 * r4 - EB4 * g4) / (BC_DA4 + ED4 - EB4), bl = b4 - l3, k5 = (E5 * (g4 - l3) - C7 * bl) / D4, s4 = Math.sqrt(k5 * k5 + bl * bl) / (E5 * l3 * (1 - l3)), h3 = s4 ? Math.atan2(k5, bl) * degrees7 - 120 : NaN;
  return new Cubehelix4(h3 < 0 ? h3 + 360 : h3, s4, l3, o3.opacity);
}
function cubehelix7(h3, s4, l3, opacity) {
...
var bisectCenter4 = bisector_default4(number_default7).center;
...
define_default5(Lab5, lab8, extend5(Color5, {
  brighter: function(k5) {
    return new Lab5(this.l + K6 * (k5 == null ? 1 : k5), this.a, this.b, this.opacity);
  },
  darker: function(k5) {
    return new Lab5(this.l - K6 * (k5 == null ? 1 : k5), this.a, this.b, this.opacity);
  },
...
function xyz2lab5(t8) {
  return t8 > t35 ? Math.pow(t8, 1 / 3) : t8 / t25 + t09;
}
function lab2xyz5(t8) {
  return t8 > t19 ? t8 * t8 * t8 : t25 * (t8 - t09);
}
...
define_default5(Hcl5, hcl8, extend5(Color5, {
  brighter: function(k5) {
    return new Hcl5(this.h, this.c, this.l + K6 * (k5 == null ? 1 : k5), this.opacity);
  },
  darker: function(k5) {
    return new Hcl5(this.h, this.c, this.l - K6 * (k5 == null ? 1 : k5), this.opacity);
  },
...
var ED5 = E6 * D5;
var EB5 = E6 * B6;
var BC_DA5 = B6 * C8 - D5 * A7;
function cubehelixConvert5(o3) {
  if (o3 instanceof Cubehelix5)
    return new Cubehelix5(o3.h, o3.s, o3.l, o3.opacity);
  if (!(o3 instanceof Rgb5))
    o3 = rgbConvert5(o3);
  var r4 = o3.r / 255, g4 = o3.g / 255, b4 = o3.b / 255, l3 = (BC_DA5 * b4 + ED5 * r4 - EB5 * g4) / (BC_DA5 + ED5 - EB5), bl = b4 - l3, k5 = (E6 * (g4 - l3) - C8 * bl) / D5, s4 = Math.sqrt(k5 * k5 + bl * bl) / (E6 * l3 * (1 - l3)), h3 = s4 ? Math.atan2(k5, bl) * degrees8 - 120 : NaN;
...
define_default5(Cubehelix5, cubehelix8, extend5(Color5, {
  ...
  rgb: function() {
    ...
    return new Rgb5(
      255 * (l3 + a5 * (A7 * cosh6 + B6 * sinh6)),
      255 * (l3 + a5 * (C8 * cosh6 + D5 * sinh6)),
      255 * (l3 + a5 * (E6 * cosh6)),
      this.opacity
    );
  }
...
function hue4(a5, b4) {
  var d3 = b4 - a5;
  return d3 ? linear6(a5, d3 > 180 || d3 < -180 ? d3 - 360 * Math.round(d3 / 360) : d3) : constant_default9(isNaN(a5) ? b4 : a5);
}
function gamma4(y5) {
  return (y5 = +y5) === 1 ? nogamma4 : function(a5, b4) {
    return b4 - a5 ? exponential4(a5, b4, y5) : constant_default9(isNaN(a5) ? b4 : a5);
  };
}
function nogamma4(a5, b4) {
  var d3 = b4 - a5;
  return d3 ? linear6(a5, d3) : constant_default9(isNaN(a5) ? b4 : a5);
}
...
function number_default8(a5, b4) {
  return a5 = +a5, b4 = +b4, function(t8) {
    return a5 * (1 - t8) + b4 * t8;
  };
}
...
function interpolateTransform4(parse, pxComma, pxParen, degParen) {
  ...
  function translate(xa, ya, xb, yb, s4, q) {
    if (xa !== xb || ya !== yb) {
      var i4 = s4.push("translate(", null, pxComma, null, pxParen);
      q.push({ i: i4 - 4, x: number_default8(xa, xb) }, { i: i4 - 2, x: number_default8(ya, yb) });
    } else if (xb || yb) {
      s4.push("translate(" + xb + pxComma + yb + pxParen);
    }
  }
  function rotate(a5, b4, s4, q) {
    if (a5 !== b4) {
      if (a5 - b4 > 180)
        ...
        a5 += 360;
      q.push({ i: s4.push(pop(s4) + "rotate(", null, degParen) - 2, x: number_default8(a5, b4) });
    } else if (b4) {
      s4.push(pop(s4) + "rotate(" + b4 + degParen);
    }
  }
  function skewX(a5, b4, s4, q) {
    if (a5 !== b4) {
      q.push({ i: s4.push(pop(s4) + "skewX(", null, degParen) - 2, x: number_default8(a5, b4) });
    } else if (b4) {
      s4.push(pop(s4) + "skewX(" + b4 + degParen);
    }
  }
...
var formatTypes_default4 = {
  ...
  "g": (x5, p4) => x5.toPrecision(p4),
  "o": (x5) => Math.round(x5).toString(8),
  "p": (x5, p4) => formatRounded_default4(x5 * 100, p4),
...
function defaultLocale7(definition) {
  locale7 = locale_default4(definition);
  format4 = locale7.format;
  formatPrefix4 = locale7.formatPrefix;
  return locale7;
}
...
function defaultLocale8(definition) {
  locale8 = formatLocale4(definition);
  timeFormat4 = locale8.format;
  timeParse4 = locale8.parse;
  utcFormat4 = locale8.utcFormat;
  utcParse4 = locale8.utcParse;
  return locale8;
}
...
var Xe = import_prop_types3.default.oneOfType([import_prop_types3.default.func, import_prop_types3.default.arrayOf(import_prop_types3.default.string), import_prop_types3.default.shape({ scheme: import_prop_types3.default.oneOf(Be).isRequired, size: import_prop_types3.default.number }), import_prop_types3.default.shape({ datum: import_prop_types3.default.string.isRequired }), import_prop_types3.default.string]);
var Ye = import_prop_types3.default.oneOfType([import_prop_types3.default.string, import_prop_types3.default.func, import_prop_types3.default.shape({ theme: import_prop_types3.default.string.isRequired }), import_prop_types3.default.shape({ from: import_prop_types3.default.string.isRequired, modifiers: import_prop_types3.default.arrayOf(import_prop_types3.default.array) })]);
var fr = function(e8, r4) {
  ...
  if (Array.isArray(e8)) {
    var t8 = ordinal3(e8), o3 = function(e9) {
      return t8(n5(e9));
    };
  ...
  if ((0, import_lodash2.isPlainObject)(e8)) {
    ...
    if (function(e9) {
      ...
      if (Fe(e8.scheme)) {
        var i4 = ordinal3($e2[e8.scheme]), u3 = function(e9) {
          return i4(n5(e9));
        };
      ...
      if (He(e8.scheme)) {
        ...
        var a5 = ordinal3($e2[e8.scheme][e8.size || 11]), l3 = function(e9) {
          return a5(n5(e9));
        };
      ...
      if (Je(e8.scheme)) {
        ...
        var s4 = ordinal3($e2[e8.scheme][e8.size || 9]), c9 = function(e9) {
          return s4(n5(e9));
        };
...
//# sourceMappingURL=chunk-L37ADFKE.js.map
