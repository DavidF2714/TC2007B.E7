...
function normalizeColor(color5) {
  ...
  if (colors && colors[color5] !== void 0) {
    return colors[color5];
  }
  if (match = rgb2.exec(color5)) {
...
function useTransition(data, props, deps) {
  ...
  each(transitions, (t6, i3) => {
    ...
    payload.onResolve = (result) => {
      ...
      const t25 = transitions2.find((t35) => t35.key === key);
      if (!t25)
        return;
      if (result.cancelled && t25.phase != "update") {
        return;
      }
      if (t25.ctrl.idle) {
        const idle = transitions2.every((t35) => t35.ctrl.idle);
        if (t25.phase == "leave") {
          const expiry = callProp(expires, t25.item);
          if (expiry !== false) {
            const expiryMs = expiry === true ? 0 : expiry;
            t25.expired = true;
            if (!idle && expiryMs > 0) {
              if (expiryMs <= 2147483647)
                t25.expirationId = setTimeout(forceUpdate, expiryMs);
              return;
            }
          }
        }
        if (idle && transitions2.some((t35) => t35.expired)) {
          exitingTransitions.current.delete(t25);
          if (exitBeforeEnter) {
  ...
  if (keys === null) {
    ...
    return items.map((item) => {
      const t6 = prevTransitions && prevTransitions.find(
        (t25) => t25.item === item && t25.phase !== "leave" && !reused.has(t25)
      );
      if (t6) {
        reused.add(t6);
        return t6.key;
...
function basis(t18, v0, v1, v22, v32) {
  var t25 = t18 * t18, t35 = t25 * t18;
  return ((1 - 3 * t18 + 3 * t25 - t35) * v0 + (4 - 6 * t25 + 3 * t35) * v1 + (1 + 3 * t18 + 3 * t25 - 3 * t35) * v22 + t35 * v32) / 6;
}
...
var rgb_default = function rgbGamma(y4) {
  ...
  function rgb7(start2, end) {
    var r3 = color5((start2 = rgb3(start2)).r, (end = rgb3(end)).r), g3 = color5(start2.g, end.g), b3 = color5(start2.b, end.b), opacity = nogamma(start2.opacity, end.opacity);
    return function(t6) {
      start2.r = r3(t6);
      start2.g = g3(t6);
      start2.b = b3(t6);
...
function rgbSpline(spline) {
  return function(colors3) {
    var n3 = colors3.length, r3 = new Array(n3), g3 = new Array(n3), b3 = new Array(n3), i3, color5;
    for (i3 = 0; i3 < n3; ++i3) {
      color5 = rgb3(colors3[i3]);
      r3[i3] = color5.r || 0;
      g3[i3] = color5.g || 0;
      b3[i3] = color5.b || 0;
    }
...
function cubehelix2(hue5) {
  return function cubehelixGamma(y4) {
    y4 = +y4;
    function cubehelix9(start2, end) {
...
function basis2(t18, v0, v1, v22, v32) {
  var t25 = t18 * t18, t35 = t25 * t18;
  return ((1 - 3 * t18 + 3 * t25 - t35) * v0 + (4 - 6 * t25 + 3 * t35) * v1 + (1 + 3 * t18 + 3 * t25 - 3 * t35) * v22 + t35 * v32) / 6;
}
...
var rgb_default2 = function rgbGamma2(y4) {
  ...
  function rgb7(start2, end) {
    var r3 = color5((start2 = rgb4(start2)).r, (end = rgb4(end)).r), g3 = color5(start2.g, end.g), b3 = color5(start2.b, end.b), opacity = nogamma2(start2.opacity, end.opacity);
    return function(t6) {
      start2.r = r3(t6);
      start2.g = g3(t6);
      start2.b = b3(t6);
...
function point5(that, t08, t18) {
  var x0 = that._x0, y0 = that._y0, x1 = that._x1, y1 = that._y1, dx = (x1 - x0) / 3;
  that._context.bezierCurveTo(x0 + dx, y0 + dx * t08, x1 - dx, y1 - dx * t18, x1, y1);
}
...
MonotoneX.prototype = {
  ...
  point: function(x5, y4) {
    ...
    switch (this._point) {
      ...
      case 2:
        this._point = 3;
        point5(this, slope2(this, t18 = slope3(this, x5, y4)), t18);
        break;
      default:
        point5(this, this._t0, t18 = slope3(this, x5, y4));
        break;
    }
    this._x0 = this._x1, this._x1 = x5;
    this._y0 = this._y1, this._y1 = y4;
...
var b = (0, import_react16.memo)(function(t6) {
  var o3, n3 = t6.position, r3 = t6.anchor, e6 = t6.children, l3 = Ut(), u3 = $r(), p3 = u3.animate, f3 = u3.config, b3 = Lt(), g3 = b3[0], w3 = b3[1], T3 = (0, import_react16.useRef)(false), C8 = void 0, E6 = false, P3 = w3.width > 0 && w3.height > 0, j3 = Math.round(n3[0]), N2 = Math.round(n3[1]);
  P3 && ("top" === r3 ? (j3 -= w3.width / 2, N2 -= w3.height + 14) : "right" === r3 ? (j3 += 14, N2 -= w3.height / 2) : "bottom" === r3 ? (j3 -= w3.width / 2, N2 += 14) : "left" === r3 ? (j3 -= w3.width + 14, N2 -= w3.height / 2) : "center" === r3 && (j3 -= w3.width / 2, N2 -= w3.height / 2), C8 = { transform: m2(j3, N2) }, T3.current || (E6 = true), T3.current = [j3, N2]);
  var O3 = useSpring({ to: C8, config: f3, immediate: !p3 || E6 }), V2 = v2({}, x3, l3.tooltip, { transform: null != (o3 = O3.transform) ? o3 : m2(j3, N2) });
...
define_default3(Rgb3, rgb5, extend3(Color3, {
  brighter: function(k4) {
...
function basis3(t18, v0, v1, v22, v32) {
  var t25 = t18 * t18, t35 = t25 * t18;
  return ((1 - 3 * t18 + 3 * t25 - t35) * v0 + (4 - 6 * t25 + 3 * t35) * v1 + (1 + 3 * t18 + 3 * t25 - 3 * t35) * v22 + t35 * v32) / 6;
}
...
var rgb_default3 = function rgbGamma3(y4) {
  var color5 = gamma3(y4);
  function rgb7(start2, end) {
    var r3 = color5((start2 = rgb5(start2)).r, (end = rgb5(end)).r), g3 = color5(start2.g, end.g), b3 = color5(start2.b, end.b), opacity = nogamma3(start2.opacity, end.opacity);
    return function(t6) {
      start2.r = r3(t6);
      start2.g = g3(t6);
      start2.b = b3(t6);
...
function hsl7(hue5) {
  return function(start2, end) {
    var h2 = hue5((start2 = hsl6(start2)).h, (end = hsl6(end)).h), s4 = nogamma3(start2.s, end.s), l3 = nogamma3(start2.l, end.l), opacity = nogamma3(start2.opacity, end.opacity);
    return function(t6) {
      start2.h = h2(t6);
      start2.s = s4(t6);
      start2.l = l3(t6);
...
function hcl6(hue5) {
  return function(start2, end) {
    var h2 = hue5((start2 = hcl5(start2)).h, (end = hcl5(end)).h), c9 = nogamma3(start2.c, end.c), l3 = nogamma3(start2.l, end.l), opacity = nogamma3(start2.opacity, end.opacity);
    return function(t6) {
      start2.h = h2(t6);
      start2.c = c9(t6);
      start2.l = l3(t6);
...
function cubehelix6(hue5) {
  return function cubehelixGamma(y4) {
    y4 = +y4;
    function cubehelix9(start2, end) {
      var h2 = hue5((start2 = cubehelix5(start2)).h, (end = cubehelix5(end)).h), s4 = nogamma3(start2.s, end.s), l3 = nogamma3(start2.l, end.l), opacity = nogamma3(start2.opacity, end.opacity);
      return function(t6) {
        start2.h = h2(t6);
        start2.s = s4(t6);
        start2.l = l3(Math.pow(t6, y4));
...
function newInterval2(floori, offseti, count4, field) {
  ...
  if (count4) {
    interval.count = function(start2, end) {
      ...
      return Math.floor(count4(t05, t15));
    };
    interval.every = function(step) {
      step = Math.floor(step);
      return !isFinite(step) || !(step > 0) ? null : !(step > 1) ? interval : interval.filter(field ? function(d3) {
...
define_default4(Rgb4, rgb6, extend4(Color4, {
  brighter: function(k4) {
...
function hsl8(h2, s4, l3, opacity) {
...
function lab7(l3, a4, b3, opacity) {
...
function xyz2lab4(t6) {
  return t6 > t34 ? Math.pow(t6, 1 / 3) : t6 / t24 + t06;
}
function lab2xyz4(t6) {
  return t6 > t16 ? t6 * t6 * t6 : t24 * (t6 - t06);
}
...
function cubehelixConvert4(o3) {
  ...
  if (!(o3 instanceof Rgb4))
    o3 = rgbConvert4(o3);
  var r3 = o3.r / 255, g3 = o3.g / 255, b3 = o3.b / 255, l3 = (BC_DA4 * b3 + ED4 * r3 - EB4 * g3) / (BC_DA4 + ED4 - EB4), bl = b3 - l3, k4 = (E5 * (g3 - l3) - C6 * bl) / D4, s4 = Math.sqrt(k4 * k4 + bl * bl) / (E5 * l3 * (1 - l3)), h2 = s4 ? Math.atan2(k4, bl) * degrees7 - 120 : NaN;
  return new Cubehelix4(h2 < 0 ? h2 + 360 : h2, s4, l3, o3.opacity);
}
function cubehelix7(h2, s4, l3, opacity) {
...
function basis4(t18, v0, v1, v22, v32) {
  var t25 = t18 * t18, t35 = t25 * t18;
  return ((1 - 3 * t18 + 3 * t25 - t35) * v0 + (4 - 6 * t25 + 3 * t35) * v1 + (1 + 3 * t18 + 3 * t25 - 3 * t35) * v22 + t35 * v32) / 6;
}
...
var rgb_default4 = function rgbGamma4(y4) {
  var color5 = gamma4(y4);
  function rgb7(start2, end) {
    var r3 = color5((start2 = rgb6(start2)).r, (end = rgb6(end)).r), g3 = color5(start2.g, end.g), b3 = color5(start2.b, end.b), opacity = nogamma4(start2.opacity, end.opacity);
    return function(t6) {
      start2.r = r3(t6);
      start2.g = g3(t6);
      start2.b = b3(t6);
...
function decompose_default4(a4, b3, c9, d3, e6, f3) {
  ...
  return {
    translateX: e6,
    translateY: f3,
    rotate: Math.atan2(b3, a4) * degrees8,
    skewX: Math.atan(skewX) * degrees8,
    scaleX,
    scaleY
  };
}
...
function hsl9(hue5) {
  return function(start2, end) {
    var h2 = hue5((start2 = hsl8(start2)).h, (end = hsl8(end)).h), s4 = nogamma4(start2.s, end.s), l3 = nogamma4(start2.l, end.l), opacity = nogamma4(start2.opacity, end.opacity);
    return function(t6) {
      start2.h = h2(t6);
      start2.s = s4(t6);
      start2.l = l3(t6);
...
var hsl_default4 = hsl9(hue4);
var hslLong4 = hsl9(nogamma4);

// node_modules/@nivo/legends/node_modules/d3-interpolate/src/hcl.js
function hcl8(hue5) {
  return function(start2, end) {
    var h2 = hue5((start2 = hcl7(start2)).h, (end = hcl7(end)).h), c9 = nogamma4(start2.c, end.c), l3 = nogamma4(start2.l, end.l), opacity = nogamma4(start2.opacity, end.opacity);
    return function(t6) {
      start2.h = h2(t6);
      start2.c = c9(t6);
      start2.l = l3(t6);
...
function cubehelix8(hue5) {
  return function cubehelixGamma(y4) {
    y4 = +y4;
    function cubehelix9(start2, end) {
      var h2 = hue5((start2 = cubehelix7(start2)).h, (end = cubehelix7(end)).h), s4 = nogamma4(start2.s, end.s), l3 = nogamma4(start2.l, end.l), opacity = nogamma4(start2.opacity, end.opacity);
      return function(t6) {
        start2.h = h2(t6);
        start2.s = s4(t6);
        start2.l = l3(Math.pow(t6, y4));
...
function newInterval3(floori, offseti, count4, field) {
  ...
  if (count4) {
    interval.count = function(start2, end) {
      ...
      return Math.floor(count4(t07, t17));
    };
    interval.every = function(step) {
      step = Math.floor(step);
      return !isFinite(step) || !(step > 0) ? null : !(step > 1) ? interval : interval.filter(field ? function(d3) {
...
var C7 = { circle: m3, diamond: f2, square: u2, triangle: v3 };
var B5 = function(i3) {
  var n3, r3, l3, c9, h2, g3, m4, f3, u3, v4, y4, b3 = i3.x, k4 = i3.y, x5 = i3.width, A6 = i3.height, W2 = i3.data, O3 = i3.direction, z3 = void 0 === O3 ? "left-to-right" : O3, B6 = i3.justify, w3 = void 0 !== B6 && B6, X2 = i3.textColor, Y2 = i3.background, H2 = void 0 === Y2 ? "transparent" : Y2, E6 = i3.opacity, j3 = void 0 === E6 ? 1 : E6, T3 = i3.symbolShape, L = void 0 === T3 ? "square" : T3, M2 = i3.symbolSize, F2 = void 0 === M2 ? 16 : M2, P3 = i3.symbolSpacing, R = void 0 === P3 ? 8 : P3, q = i3.symbolBorderWidth, V2 = void 0 === q ? 0 : q, D5 = i3.symbolBorderColor, G = void 0 === D5 ? "transparent" : D5, I = i3.onClick, N2 = i3.onMouseEnter, _ = i3.onMouseLeave, J = i3.toggleSerie, K5 = i3.effects, Q = (0, import_react18.useState)({}), U = Q[0], Z = Q[1], $ = Ut(), tt2 = (0, import_react18.useCallback)(function(t6) {
    if (K5) {
      var e6 = K5.filter(function(t7) {
        return "hover" === t7.on;
    ...
    null == N2 || N2(W2, t6);
  }, [N2, W2, K5]), et2 = (0, import_react18.useCallback)(function(t6) {
    if (K5) {
      var e6 = K5.filter(function(t7) {
        return "hover" !== t7.on;
      }).reduce(function(t7, e7) {
    ...
    null == _ || _(W2, t6);
  }, [_, W2, K5]), it2 = S({ direction: z3, justify: w3, symbolSize: null != (n3 = U.symbolSize) ? n3 : F2, symbolSpacing: R, width: x5, height: A6 }), nt2 = it2.symbolX, ot = it2.symbolY, rt2 = it2.labelX, lt = it2.labelY, at = it2.labelAnchor, ct2 = it2.labelAlignment, st = [I, N2, _, J].some(function(t6) {
    return void 0 !== t6;
  }), dt = "function" == typeof L ? L : C7[L];
  return (0, import_jsx_runtime3.jsxs)("g", { transform: "translate(" + b3 + "," + k4 + ")", style: { opacity: null != (r3 = U.itemOpacity) ? r3 : j3 }, children: [(0, import_jsx_runtime3.jsx)("rect", { width: x5, height: A6, fill: null != (l3 = U.itemBackground) ? l3 : H2, style: { cursor: st ? "pointer" : "auto" }, onClick: function(t6) {
...
var w2 = function(e6) {
  var i3 = e6.data, n3 = e6.x, o3 = e6.y, r3 = e6.direction, l3 = e6.padding, a4 = void 0 === l3 ? 0 : l3, c9 = e6.justify, s4 = e6.effects, d3 = e6.itemWidth, h2 = e6.itemHeight, g3 = e6.itemDirection, m4 = void 0 === g3 ? "left-to-right" : g3, f3 = e6.itemsSpacing, u3 = void 0 === f3 ? 0 : f3, v4 = e6.itemTextColor, p3 = e6.itemBackground, y4 = void 0 === p3 ? "transparent" : p3, b3 = e6.itemOpacity, x5 = void 0 === b3 ? 1 : b3, S2 = e6.symbolShape, A6 = e6.symbolSize, W2 = e6.symbolSpacing, O3 = e6.symbolBorderWidth, z3 = e6.symbolBorderColor, C8 = e6.onClick, w3 = e6.onMouseEnter, X2 = e6.onMouseLeave, Y2 = e6.toggleSerie, H2 = k3({ itemCount: i3.length, itemWidth: d3, itemHeight: h2, itemsSpacing: u3, direction: r3, padding: a4 }).padding, E6 = "row" === r3 ? d3 + u3 : 0, j3 = "column" === r3 ? h2 + u3 : 0;
  return (0, import_jsx_runtime3.jsx)("g", { transform: "translate(" + n3 + "," + o3 + ")", children: i3.map(function(e7, i4) {
    return (0, import_jsx_runtime3.jsx)(B5, { data: e7, x: i4 * E6 + H2.left, y: i4 * j3 + H2.top, width: d3, height: h2, direction: m4, justify: c9, effects: s4, textColor: v4, background: y4, opacity: x5, symbolShape: S2, symbolSize: A6, symbolSpacing: W2, symbolBorderWidth: O3, symbolBorderColor: z3, onClick: C8, onMouseEnter: w3, onMouseLeave: X2, toggleSerie: Y2 }, i4);
  }) });
};
var X = function(e6) {
  var i3 = e6.data, n3 = e6.containerWidth, o3 = e6.containerHeight, r3 = e6.translateX, l3 = void 0 === r3 ? 0 : r3, a4 = e6.translateY, c9 = void 0 === a4 ? 0 : a4, s4 = e6.anchor, d3 = e6.direction, h2 = e6.padding, g3 = void 0 === h2 ? 0 : h2, m4 = e6.justify, f3 = e6.itemsSpacing, u3 = void 0 === f3 ? 0 : f3, v4 = e6.itemWidth, p3 = e6.itemHeight, y4 = e6.itemDirection, b3 = e6.itemTextColor, S2 = e6.itemBackground, A6 = e6.itemOpacity, W2 = e6.symbolShape, O3 = e6.symbolSize, z3 = e6.symbolSpacing, C8 = e6.symbolBorderWidth, B6 = e6.symbolBorderColor, X2 = e6.onClick, Y2 = e6.onMouseEnter, H2 = e6.onMouseLeave, E6 = e6.toggleSerie, j3 = e6.effects, T3 = k3({ itemCount: i3.length, itemsSpacing: u3, itemWidth: v4, itemHeight: p3, direction: d3, padding: g3 }), L = T3.width, M2 = T3.height, F2 = x4({ anchor: s4, translateX: l3, translateY: c9, containerWidth: n3, containerHeight: o3, width: L, height: M2 }), P3 = F2.x, R = F2.y;
  return (0, import_jsx_runtime3.jsx)(w2, { data: i3, x: P3, y: R, direction: d3, padding: g3, justify: m4, effects: j3, itemsSpacing: u3, itemWidth: v4, itemHeight: p3, itemDirection: y4, itemTextColor: b3, itemBackground: S2, itemOpacity: A6, symbolShape: W2, symbolSize: O3, symbolSpacing: z3, symbolBorderWidth: C8, symbolBorderColor: B6, onClick: X2, onMouseEnter: Y2, onMouseLeave: H2, toggleSerie: "boolean" == typeof E6 ? void 0 : E6 });
};
var Y = { start: "left", middle: "center", end: "right" };
var H = function(t6, e6) {
  var i3 = e6.data, n3 = e6.containerWidth, o3 = e6.containerHeight, r3 = e6.translateX, l3 = void 0 === r3 ? 0 : r3, a4 = e6.translateY, c9 = void 0 === a4 ? 0 : a4, s4 = e6.anchor, d3 = e6.direction, h2 = e6.padding, g3 = void 0 === h2 ? 0 : h2, m4 = e6.justify, f3 = void 0 !== m4 && m4, u3 = e6.itemsSpacing, v4 = void 0 === u3 ? 0 : u3, p3 = e6.itemWidth, y4 = e6.itemHeight, b3 = e6.itemDirection, A6 = void 0 === b3 ? "left-to-right" : b3, W2 = e6.itemTextColor, O3 = e6.symbolSize, z3 = void 0 === O3 ? 16 : O3, C8 = e6.symbolSpacing, B6 = void 0 === C8 ? 8 : C8, w3 = e6.theme, X2 = k3({ itemCount: i3.length, itemWidth: p3, itemHeight: y4, itemsSpacing: v4, direction: d3, padding: g3 }), H2 = X2.width, E6 = X2.height, j3 = X2.padding, T3 = x4({ anchor: s4, translateX: l3, translateY: c9, containerWidth: n3, containerHeight: o3, width: H2, height: E6 }), L = T3.x, M2 = T3.y, F2 = "row" === d3 ? p3 + v4 : 0, P3 = "column" === d3 ? y4 + v4 : 0;
  t6.save(), t6.translate(L, M2), t6.font = w3.legends.text.fontSize + "px " + (w3.legends.text.fontFamily || "sans-serif"), i3.forEach(function(e7, i4) {
    var n4, o4, r4 = i4 * F2 + j3.left, l4 = i4 * P3 + j3.top, a5 = S({ direction: A6, justify: f3, symbolSize: z3, symbolSpacing: B6, width: p3, height: y4 }), c10 = a5.symbolX, s5 = a5.symbolY, d4 = a5.labelX, h3 = a5.labelY, g4 = a5.labelAnchor, m5 = a5.labelAlignment;
...
lodash/lodash.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-LHKJKD76.js.map
