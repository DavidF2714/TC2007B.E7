...
=======
} from "./chunk-KI5TOZDI.js";
import "./chunk-NQEP3LUU.js";
import "./chunk-E5CV6KCD.js";
...
function path_default(projection2, context) {
  ...
  path.projection = function(_2) {
    return arguments.length ? (projectionStream = _2 == null ? (projection2 = null, identity_default3) : (projection2 = _2).stream, path) : projection2;
  };
...
function projectionMutator(projectAt) {
  var project, k2 = 150, x = 480, y2 = 250, lambda = 0, phi = 0, deltaLambda = 0, deltaPhi = 0, deltaGamma = 0, rotate, alpha = 0, sx = 1, sy = 1, theta = null, preclip = antimeridian_default, x05 = null, y05, x12, y12, postclip = identity_default3, delta2 = 0.5, projectResample, projectTransform, projectRotateTransform, cache, cacheStream;
...
var z = function(r2) {
  var o2 = r2.width, t2 = r2.height, i2 = r2.projectionType, n2 = r2.projectionScale, u = r2.projectionTranslation, l = r2.projectionRotation, c = r2.fillColor, d = r2.borderWidth, s = r2.borderColor, f = (0, import_react.useMemo)(function() {
    ...
    return graticule();
  }), g = Ut(), v = (0, import_react.useMemo)(function() {
...
var K = function(r2) {
  var o2 = r2.features, t2 = r2.data, i2 = r2.match, n2 = r2.label, a = r2.value, l = r2.valueFormat, c = r2.colors, d = r2.unknownColor, s = r2.domain, f = (0, import_react.useMemo)(function() {
    return (0, import_lodash.isFunction)(i2) ? i2 : function(e3, r3) {
      var o3 = (0, import_lodash.get)(e3, i2), t3 = (0, import_lodash.get)(r3, i2);
      return o3 && o3 === t3;
    };
  }, [i2]), h = (0, import_react.useMemo)(function() {
    return (0, import_lodash.isFunction)(n2) ? n2 : function(e3) {
      return (0, import_lodash.get)(e3, n2);
    };
  }, [n2]), p = (0, import_react.useMemo)(function() {
    return (0, import_lodash.isFunction)(a) ? a : function(e3) {
      return (0, import_lodash.get)(e3, a);
    };
  }, [a]), g = (0, import_react.useMemo)(function() {
    return void 0 === l ? function(e3) {
      return e3;
    } : (0, import_lodash.isFunction)(l) ? l : format(l);
  }, [l]), v = (0, import_react.useMemo)(function() {
    return it(c).domain(s);
...
var ne = (0, import_react.memo)(function(e3) {
  var r2 = e3.width, i2 = e3.height, n2 = e3.margin, u = e3.features, l = e3.layers, s = e3.projectionType, f = e3.projectionScale, h = e3.projectionTranslation, p = e3.projectionRotation, g = e3.fillColor, m2 = e3.borderWidth, C = e3.borderColor, b = e3.enableGraticule, y2 = e3.graticuleLineWidth, R2 = e3.graticuleLineColor, j2 = e3.isInteractive, q = e3.onClick, T = e3.tooltip, M2 = e3.role, W = Gt(r2, i2, n2), w2 = W.margin, k2 = W.outerWidth, O = W.outerHeight, F = z({ width: r2, height: i2, projectionType: s, projectionScale: f, projectionTranslation: h, projectionRotation: p, fillColor: g, borderWidth: m2, borderColor: C }), L = F.graticule, E = F.path, S = F.getFillColor, G = F.getBorderWidth, x = F.getBorderColor, B = Ut(), P = k(), N = P.showTooltipFromEvent, I2 = P.hideTooltip, D2 = (0, import_react.useCallback)(function(e4, r3) {
    return j2 && q && q(e4, r3);
  ...
  return (0, import_jsx_runtime.jsx)(wi, { width: k2, height: O, margin: w2, theme: B, role: M2, children: l.map(function(r3, o2) {
...
var fe = (0, import_react.memo)(function(e3) {
  ...
  return (0, import_jsx_runtime.jsx)(wi, { width: J2, height: Q2, margin: A5, theme: ae2, defs: ue2, role: G, children: O.map(function(e4, o2) {
...
fe.displayName = "Choropleth", fe.propTypes = X3, fe.defaultProps = re2;
var he = ji(fe);
var pe = function(e3) {
  return (0, import_jsx_runtime.jsx)(Qt, { children: function(r2) {
    var o2 = r2.width, t2 = r2.height;
...
var ve = (0, import_react.memo)(function(e3) {
  var r2 = e3.width, t2 = e3.height, u = e3.margin, l = e3.pixelRatio, d = e3.features, s = e3.data, f = e3.match, h = e3.label, p = e3.value, g = e3.valueFormat, m2 = e3.projectionType, C = e3.projectionScale, b = e3.projectionTranslation, y2 = e3.projectionRotation, R2 = e3.colors, j2 = e3.domain, q = e3.unknownColor, T = e3.borderWidth, M2 = e3.borderColor, W = e3.enableGraticule, w2 = e3.graticuleLineWidth, k2 = e3.graticuleLineColor, O = e3.layers, F = e3.legends, L = e3.isInteractive, E = e3.onClick, S = e3.onMouseMove, G = e3.tooltip, x = (0, import_react.useRef)(null), B = Ut(), P = Gt(r2, t2, u), D2 = P.margin, V2 = P.outerWidth, A5 = P.outerHeight, J2 = z({ width: r2, height: t2, projectionType: m2, projectionScale: C, projectionTranslation: b, projectionRotation: y2, fillColor: function() {
  }, borderWidth: T, borderColor: M2 }), Q2 = J2.projection, U2 = J2.graticule, X4 = J2.path, Y3 = J2.getBorderWidth, Z3 = J2.getBorderColor, $2 = K({ features: d, data: s, match: f, label: h, value: p, valueFormat: g, colors: R2, unknownColor: q, domain: j2 }), _2 = $2.getFillColor, ee2 = $2.boundFeatures, re3 = $2.legendData;
  (0, import_react.useEffect)(function() {
    if (x) {
      x.current.width = V2 * l, x.current.height = A5 * l;
      var e4 = x.current.getContext("2d");
      e4.scale(l, l), e4.fillStyle = B.background, e4.fillRect(0, 0, V2, A5), e4.translate(D2.left, D2.top), X4.context(e4), O.forEach(function(o2) {
        "graticule" === o2 ? true === W && (e4.lineWidth = w2, e4.strokeStyle = k2, e4.beginPath(), X4(U2()), e4.stroke()) : "features" === o2 ? ee2.forEach(function(r3) {
          ...
          H(e4, I({}, o3, { data: re3, containerWidth: r2, containerHeight: t2, theme: B }));
        });
      });
    }
  }, [x, V2, A5, D2, l, B, X4, U2, _2, Y3, Z3, ee2, F, O]);
